...
class TestStruct1(object):
    ...
    def expectedParameters(expected):
        ...
        INT32_ELEMENT(expected).key("exampleIntKey")
                ...
                .commit()
                ,
#        BITSET32_ELEMENT(expected).key("exampleBitsKey1").alias([12,1,33])
#                .tags("hardware")
#                .displayedName("Example bits key 1")
#                .description("Example bits key 1 description")
#                .reconfigurable()
#                .options("0:in error, 1:busy, 5:HV On, 8:Crate On", ",")
#                .assignmentOptional().defaultValue(0xdeadbeef)
#                .commit()
#                ,
#        BITSET64_ELEMENT(expected).key("exampleBitsKey2").alias([12,1,33,44])
#                .tags("hardware")
#                .displayedName("Example bits key 2")
#                .description("Example bits key 2 description")
#                .reconfigurable()
#                .options("10:In Error, 21:Busy, 35:HV On, 55:Crate On", ",")
#                .assignmentOptional().defaultValue(0xdeadbeefdeadface)
#                .commit()
#                ,
#        BITSET16_ELEMENT(expected).key("exampleBitsKey3").alias([12,1])
#                .tags("hardware")
#                .displayedName("Example bits key 3")
#                .description("Example bits key 3 description")
#                .reconfigurable()
#                .options("10:In Error, 11:Busy, 14:HV on, 15:Crate on", ",")
#                .assignmentOptional().defaultValue(0xbeef)
#                .commit()
#                ,
#        BITSET8_ELEMENT(expected).key("exampleBitsKey4").alias([12,2])
#                .tags("hardware")
#                .displayedName("Example bits key 4")
#                .description("Example bits key 4 description")
#                .reconfigurable()
#                .options("1:In Error, 2:busy, 3:HV on, 7:Crate on", ",")
#                .assignmentOptional().defaultValue(0xbe)
#                .commit()
#                ,
