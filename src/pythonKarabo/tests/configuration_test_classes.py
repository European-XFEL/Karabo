...
class Circle(Shape):
    ...
    def expectedParameters(expected):
        ...
        e = FLOAT_ELEMENT(expected).key("radius").alias(1)
        e.description("The radius of the circle")
        e.displayedName("Radius")
        e.minExc(0).maxExc(100)
        e.unit(Units.METER).metricPrefix(Units.MILLI)
...
class Rectangle(Shape):
    ...
    def expectedParameter(expected):
        ...
        e = FLOAT_ELEMENT(expected).key("a").alias(1)
        ...
        e = FLOAT_ELEMENT(expected).key("b").alias(1)
...
class TestStruct1(object):
    ...
    def expectedParameters(expected):
        ...
        e = FLOAT_ELEMENT(expected).key("exampleKey4").alias("exampleAlias4")
        e.tags("software")
