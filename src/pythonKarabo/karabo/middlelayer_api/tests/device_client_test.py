...
from karabo.middlelayer import (
    getConfigurationFromPast, Hash, KaraboError, Schema, SignalSlotable
)
...
def test_getConfigurationFromPast(_getLogReaderId, get_instance):
    # REMOVE the @synchronize wrapping
    global getConfigurationFromPast
    ...
    @coroutine
    def sub_test_2():
        h, s = yield from getConfigurationFromPast("aDeviceInHistory", time)
