...
from aio_pika.connection import Connection, ConnectionType, connect
...
async def connect_cluster(
    ...
    *,
    ...
    connection_class: Type[ConnectionType] = ClusterConnection,
    ...
    **kwargs
    ...
    .. code-block:: python
        ...
        async def main():
            connection = await aio_pika.connect_cluster(
