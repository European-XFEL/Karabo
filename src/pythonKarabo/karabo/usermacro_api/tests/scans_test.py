...
from karabo.usermacros import AScan
...
class Tests(DeviceTest):
    ...
    @sync_tst
    def test_len_2_1D_rectilinear_trajectory_split_2(self):
        """Test the split in 2 of a 2 points 1D trajectory"""
        result = [point for point in AScan.splitTrajectory([0, 20], 2)]
    ...
    def test_len_2_3D_rectilinear_trajectory_split_4(self):
        ...
        result = [(tuple(point), pause)
                  for point, pause in
                  AScan.splitTrajectory([(0, 0, 0), (1, 1, 1),
                                         (20, 20, 20)], 4)]
    ...
    def test_len_4_3D_rectilinear_trajectory_split_2(self):
        ...
        result = [(tuple(point), pause)
                  for point, pause in
                  AScan.splitTrajectory([(0, -5, 1), (0, 0, 1),
                                         (10, 0, 1), (10, -5, 1)], 2)]
        print(result)
    ...
    def test_len_3_1D_rectilinear_trajectory_split_2(self):
        """Test the split in 2 of a 3 points 1D trajectory"""
        result = [point for point in AScan.splitTrajectory([1, 10, 20], 2)]
        oracle = [(1, True), (10, False), (10.5, True), (20, True)]

        self.assertEqual(result, oracle)

    def test_len_3_1D_rectilinear_trajectory_split_177(self):
        """Test against linspace the split in 177 of a 1D trajectory"""
        traj = [1, 10, 20]
        num = 177
        result = []
        for point, pause in AScan.splitTrajectory(traj, num):
            if pause:
                result.append(point)
