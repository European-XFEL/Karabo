...
def test_deprecated_image_widgets():
    _check_simple_image_widget(old_klass=api.DisplayAlignedImageModel,
                               new_klass=api.DetectorGraphModel)
    _check_simple_image_widget(old_klass=api.DisplayImageModel,
                               new_klass=api.ImageGraphModel)
    _check_simple_image_widget(old_klass=api.DisplayImageElementModel,
                               new_klass=api.WebCamGraphModel)
