...
public final class BinaryFileOutputHash extends OutputHash {
    ...
    static {
        KARABO_REGISTER_FOR_CONFIGURATION(OutputHash.class, BinaryFileOutputHash.class);
    ...
    public BinaryFileOutputHash(Hash config) {
        super(config);
