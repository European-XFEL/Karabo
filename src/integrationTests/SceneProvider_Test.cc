...
void SceneProvider_Test::appTestRunner() {
    ...
    std::pair<bool, std::string> success = m_deviceClient->instantiate("testServerSceneProvider", "GuiServerDevice", Hash("deviceId", "testGuiServerScenes", "port", 44447), KRB_TEST_MAX_TIMEOUT);
