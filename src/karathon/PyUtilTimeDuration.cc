...
void exportPyUtilTimeDuration() {
    ...
    t.def("fromHash"
          , (void (TimeDuration::*)(Hash const &))(&TimeDuration::fromHash)
          , (bp::arg("hash")));

    t.def("getDays"
          , (unsigned long int (TimeDuration::*)()const) (&TimeDuration::getDays));
    ...
    t.def("getSeconds"
          , (TimeValue(TimeDuration::*)()const) (&TimeDuration::getSeconds));

    t.def("getTotalHours"
          , (TimeValue(TimeDuration::*)()const) (&TimeDuration::getTotalHours));

    t.def("getTotalMinutes"
          , (TimeValue(TimeDuration::*)()const) (&TimeDuration::getTotalMinutes));

    t.def("getTotalSeconds"
          , (TimeValue(TimeDuration::*)()const) (&TimeDuration::getTotalSeconds));

    t.def("isNull"
          , (bool (TimeDuration::*)() const) (&TimeDuration::isNull));

    t.def("setDefaultFormat"
          , (void (*)(string const &))(&TimeDuration::setDefaultFormat)
          , (bp::arg("fmt")));
