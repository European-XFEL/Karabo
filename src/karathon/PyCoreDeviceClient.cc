...
void exportPyCoreDeviceClient() {
    ...
    bp::class_<DeviceClientWrap, bp::bases<DeviceClient>, boost::noncopyable > ("DeviceClient")
            ...
            .def("cacheAndGetDeviceSchema", (Schema(DeviceClientWrap::*)(const string&))(&DeviceClientWrap::cacheAndGetDeviceSchema),(bp::arg("deviceId")))
            .def("cacheAndGetConfiguration", (Hash(DeviceClientWrap::*)(const string&))(&DeviceClientWrap::cacheAndGetConfiguration),(bp::arg("deviceId")))
            .def("getConfigurationNoWait", &DeviceClientWrap::getConfigurationNoWaitPy, (bp::arg("deviceId")))
