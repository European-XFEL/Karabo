...
void exportPyIoH5File() {
...

    {
        ...
        t.def("write"
              ...
              "The hash must be compatible with the table definition. "
              "Take note that the Hash values must be arrays/lists where the first array dimension is equal to the bufferLen."
              );
        ...
        t.def("bind"
              ...
              "the corresponding key/value pair is created in the hash. If the key/value pair exists it is not touched. "
        ...
        t.def("read"
              ...
              , "Read bufferLen number of data records from the table and fill the hash which has been bound to that table. "
              "Returns the number of read records."
              );
    ...
    {
        bp::class_<h5::File, boost::noncopyable > f("H5file", "karabo interface to hdf5", bp::init< std::string const &>());
        ...
        f.def("getTable"
              ...
              , "Get the H5table specified by name and use user supplied data format which must be compatible with the table definition in the file. "
        ...
        f.def("getTable"
              ...
              , (bp::arg("name"))
              , "Get the H5table specified by name."
              );

        f.def("getName"
              , (string(h5::File::*)() const) (&h5::File::getName)
              , "Get the file name."
              );
