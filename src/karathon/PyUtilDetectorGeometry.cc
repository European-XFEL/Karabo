...
void exportPyUtilDetectorGeometry() {
    ...
    d.def("setOffsets", &DetectorGeometry::setOffsets, (bp::arg("x"), bp::arg("y"), bp::arg("z")), bp::return_internal_reference<>());
    d.def("setRotations", &DetectorGeometry::setRotations, (bp::arg("theta"), bp::arg("phi"), bp::arg("omega")), bp::return_internal_reference<>());
    ...
    d.def("setPixelRegion", &DetectorGeometry::setPixelRegion, (bp::arg("x0"), bp::arg("y0"), bp::arg("x1"), bp::arg("y1")), bp::return_internal_reference<>());
