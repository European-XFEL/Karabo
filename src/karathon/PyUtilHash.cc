...
typedef karabo::util::Element<std::string,
...
void exportPyUtilHash() {
    ...
    bp::class_<Hash::Attributes::Node, boost::shared_ptr<Hash::Attributes::Node> > an("HashAttributesNode",
                                                                                      bp::no_init);
    ...
    an.def("setValue", &AttributesNodeWrap().setValue, (bp::arg("value")),
    ...
    an.def("getValueAs", &AttributesNodeWrap().getValueAs, (bp::arg("type")),
           "Get value as a type given as an argument for current node");
    ...
    a.def("getNode", &AttributesWrap().getNode, (bp::arg("key")),
          "Returns HashAttributesNode object associated with \"key\" attribute.");
    a.def("get", &AttributesWrap().get, (bp::arg("key")), "Returns value for \"key\" attribute.");
    a.def("__getitem__", &AttributesWrap().__getitem__, (bp::arg("key")),
          "Pythonic style for getting value of attribute: x = attrs['abc']");
    a.def("getAs", &AttributesWrap().getAs, (bp::arg("key"), bp::arg("type")),
          "Get the value of the \"key\" attribute and convert it to type \"type\".");
    ...
    a.def("__setitem__", &AttributesWrap().set, (bp::arg("key"), bp::arg("value")),
          "Pythonic style for setting value of attribute: attrs['abc'] = 123");
    ...
    n.def("getValueAs", &NodeWrap().getValueAs, (bp::arg("type")),
          "Gets the value of current node converted to given reference type");
    n.def("setAttribute", &NodeWrap().setAttribute, (bp::arg("key"), bp::arg("value")),
          "Sets the \"key\" attribute to some \"value\" in current node.");
    n.def("getAttribute", &NodeWrap().getAttribute, (bp::arg("key")),
          "Gets the value of \"key\" attribute  in current node.");
    n.def("getAttributeAs", &NodeWrap().getAttributeAs, (bp::arg("key"), bp::arg("type")),
          "Gets the value of \"key\" attribute converted to type \"type\".");
    n.def("hasAttribute", &NodeWrap().hasAttribute, (bp::arg("key")),
          "Check that current node has the \"key\" attribute.");
    n.def("setAttributes", &NodeWrap().setAttributes, (bp::arg("attributes")),
          "Sets new set of attributes in current node.");
    n.def("getAttributes", &NodeWrap().getAttributes, bp::return_internal_reference<1>(),
          "Gets all attributes in current node as HashAttributes object. This object is internal reference not a "
          "copy.");
    n.def("copyAttributes", &NodeWrap().copyAttributes,
    ...
    bp::class_<Hash, boost::shared_ptr<Hash> > h("Hash",
    ...
    h.def("__setitem__", &HashWrap().set, (bp::arg("path"), bp::arg("value"), bp::arg("sep") = "."),
          "h[path] = value <==> h.set(path, value)\nUse this setting of the new path/value item if the default "
          "separator fits."
          "\nExample:\n\th = Hash()\n\th['a.b.c'] = 1\n\th.set('x/y/z', 2, \"/\")\n\th['u/v/w'] = 3\n\tprint h");
    ...
    h.def("merge", &HashWrap().merge,
          (bp::arg("hash"), bp::arg("policy") = Hash::REPLACE_ATTRIBUTES, bp::arg("selectedPaths") = bp::object(),
           bp::arg("sep") = "."),
    ...
    //    h.def("__add__", &Hash::operator+, (bp::arg("hash1"), bp::arg("hash2")),
    //    bp::return_value_policy<copy_non_const_reference>());
    h.def("__iadd__", &Hash::operator+=, (bp::arg("hash")), bp::return_internal_reference<>(),
          "This form of merging is preferable.\nExample:\n"
          "\th = Hash('a.b1.c', 22)\n\th2 = Hash('a.b2.c', 33)\n\th += h2");
    h.def("subtract", &Hash::subtract, (bp::arg("hash")), "h.subtract(h2) <==> h -= h2  :  subtracting 'h2' from 'h'");
    //    h.def("__add__", &Hash::operator+, (bp::arg("hash1"), bp::arg("hash2")),
    //    bp::return_value_policy<copy_non_const_reference>());
    ...
    // h.def("copy", &HashWrap().pyDict2Hash, (bp::arg("dict"), bp::arg("sep") = "."),
    ...
    h.def("setNode", &HashWrap().setNode, (bp::arg("node")),
          ...
          "\th = Hash('a.b.c', 1, 'b.x', 2.22, 'b.y', 7.432, 'c', [1,2,3])\n\t"
          "n = h.getNode('b')\n\tg = Hash()\n\tg.setNode(n)\n\tprint g");
    h.def("getNode", &HashWrap().getNode,
          (bp::arg("path"), bp::arg("sep") = "."), // bp::return_internal_reference<1> (),
    ...
    h.def("getAttribute", &HashWrap().getAttribute, (bp::arg("path"), bp::arg("attribute"), bp::arg("sep") = "."),
          ...
          "h = Hash('a.b.c', 1, 'b.x', 2.22, 'b.y', 7.432, 'c', [1,2,3])\n\th.setAttribute('a.b.c', 'attr1', "
          "[1.234,2.987,5.555]\n\t"
          "assert h.getAttribute('a.b.c', 'attr1') == [1.234,2.987,5.555]");
    h.def("getAttributeAs", &HashWrap().getAttributeAs,
          (bp::arg("path"), bp::arg("attribute"), bp::arg("type"), bp::arg("sep") = "."),
          "h.getAttributeAs(path, attribute, type, sep = '.') -> value of 'type' type.\nExample:\n\t"
          "h = Hash('a.b.c', 1, 'b.x', 2.22, 'b.y', 7.432, 'c', [1,2,3])\n\th.setAttribute('a.b.c', 'attr1', "
          "[1.234,2.987,5.555])\n"
          "\nHere you have to be sure that you have imported numpy as np:\n\n\timport numpy as np\n\t"
          "assert h.getAttributeAs('a.b.c', 'attr1', Types.NDARRAY).all() == np.array([1.234,2.987,5.555], "
          "dtype=np.double).all()");
    h.def("getAttributes", &HashWrap().getAttributes, (bp::arg("path"), bp::arg("sep") = "."),
          bp::return_internal_reference<1>(),
          "h.getAttributes(path, sep='.') -> iterable container of attributes which is an internal reference, not a "
          "copy.\nExample:\n\t"
          "h = Hash('a.b.c', 1, 'b.x', 2.22, 'b.y', 7.432, 'c', [1,2,3])\n\t"
    ...
    h.def("setAttribute", &HashWrap().setAttribute,
          (bp::arg("path"), bp::arg("attribute"), bp::arg("value"), bp::arg("sep") = "."),
          "Set attribute associated with path.\nExample:\n\th = Hash('a.b.c', 1, 'b.x', 2.22, 'b.y', 7.432, 'c', "
          "[1,2,3])\n\t"
          "h.setAttribute('a.b.c', 'attr1', [1.234,2.987,5.555])\n\tassert h.getAttribute('a.b.c', 'attr1') == "
          "[1.234,2.987,5.555]");
    h.def("setAttributes", &HashWrap().setAttributes, (bp::arg("path"), bp::arg("attributes"), bp::arg("sep") = "."),
          "h.setAttributes(path, attributes, sep='.') allows to associate 'attributes' with 'path' in this "
          "Hash.\nExample:\n\t"
          "h = Hash('a.b.c', 1, 'b.x', 2.22, 'b.y', 7.432, 'c', [1,2,3])\n\t"
          "h.setAttribute('a.b.c', 'attr1', [1.234,2.987,5.555])\n\th.setAttribute('a.b.c', 'attr2', 1)\n\t"
    ...
    bp::class_<std::vector<boost::shared_ptr<Hash> >, boost::shared_ptr<std::vector<boost::shared_ptr<Hash> > > >(
          "VectorHashPointer")
