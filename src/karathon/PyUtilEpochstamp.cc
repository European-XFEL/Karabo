...
void exportPyUtilEpochstamp() {
    ...
    e.def("getTimeOfDay", (timeval(Epochstamp::*)() const)(&Epochstamp::getTimeOfDay));

    e.def("getClockTime", (timespec(Epochstamp::*)() const)(&Epochstamp::getClockTime));
    ...
    e.def("toHashAttributes", &Epochstamp::toHashAttributes, bp::arg("attributes"));

    e.def("hashAttributesContainTimeInformation", &Epochstamp::hashAttributesContainTimeInformation,
          bp::arg("attributes"));
    e.staticmethod("hashAttributesContainTimeInformation");

    e.def("toIso8601", (string(Epochstamp::*)(karabo::util::TIME_UNITS, bool) const)(&Epochstamp::toIso8601),
          (bp::arg("precision") = karabo::util::MICROSEC, bp::arg("extended") = (bool)(false)));

    e.def("toIso8601Ext", (string(Epochstamp::*)(karabo::util::TIME_UNITS, bool) const)(&Epochstamp::toIso8601Ext),
          (bp::arg("precision") = karabo::util::MICROSEC, bp::arg("extended") = (bool)(false)));
