...
namespace karabo {
    namespace pyexfel {
        ...
        public:
            ...
            static bp::object pythonGetKey(boost::optional<karabo::util::Hash::Node&> node) {
                return bp::object(node->getKey());
            }

            static void pythonSetValue(boost::optional<karabo::util::Hash::Node&> node, const bp::object& obj) {
                boost::any any;
                Wrapper::toAny(obj, any);
                node->setValue(any);
            }

            static bp::object pythonGetValue(boost::optional<karabo::util::Hash::Node&> node) {
                return Wrapper::toObject(node->getValueAsAny());
            }

            static bp::object pythonGetValueAs(boost::optional<karabo::util::Hash::Node&> node, const std::string& type) {
...
//                        return Wrapper::fromStdVectorToPyList(node->getValueAs<karabo::util::Hash, std::vector>());
            ...
            static void pythonSetAttribute(boost::optional<karabo::util::Hash::Node&> node, const std::string& key, const bp::object& obj) {
                boost::any value;
                Wrapper::toAny(obj, value);
                node->setAttribute(key, value);
            }

            static bp::object pythonGetAttribute(boost::optional<karabo::util::Hash::Node&> node, const std::string& key) {
                return Wrapper::toObject(node->getAttributeAsAny(key));
            }

            static bp::object pythonGetAttributeAs(boost::optional<karabo::util::Hash::Node&> node, const std::string& key, const std::string& type) {
                using namespace karabo::util;
                Types::ReferenceType reftype = Types::from<FromLiteral>(type);
                switch (reftype) {
                    case Types::ANY:
...
//                        return Wrapper::fromStdVectorToPyList(node->getAttributeAs<karabo::util::Hash, std::vector>(key));
            ...
            static bool pythonHasAttribute(boost::optional<karabo::util::Hash::Node&> node, const std::string& key) {
                return node->hasAttribute(key);
            }

            static void pythonSetAttributes(boost::optional<karabo::util::Hash::Node&> node, const bp::object& obj) {
            ...
            static bp::object pythonGetAttributes(boost::optional<karabo::util::Hash::Node&> node) {
