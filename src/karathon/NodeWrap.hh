...
namespace karabo {
    namespace pyexfel {
        ...
        public:
            ...
            static bp::object pythonGetKey(karabo::util::Hash::Node& node) {
                return bp::object(node.getKey());
            }

            static void pythonSetValue(karabo::util::Hash::Node& node, const bp::object& obj) {
                boost::any any;
                Wrapper::toAny(obj, any);
                node.setValue(any);
            }

            static bp::object pythonGetValue(karabo::util::Hash::Node& node) {
                return Wrapper::toObject(node.getValueAsAny());
            }

            static bp::object pythonGetValueAs(karabo::util::Hash::Node& node, const std::string& type) {
            ...
            static void pythonSetAttribute(karabo::util::Hash::Node& node, const std::string& key, const bp::object& obj) {
                boost::any value;
                Wrapper::toAny(obj, value);
                node.setAttribute(key, value);
            }

            static bp::object pythonGetAttribute(karabo::util::Hash::Node& node, const std::string& key) {
                return Wrapper::toObject(node.getAttributeAsAny(key));
            }

            static bp::object pythonGetAttributeAs(karabo::util::Hash::Node& node, const std::string& key, const std::string& type) {
                using namespace karabo::util;
                Types::ReferenceType reftype = Types::from<FromLiteral>(type);
                switch (reftype) {
                    case Types::ANY:
            ...
            static bool pythonHasAttribute(karabo::util::Hash::Node& node, const std::string& key) {
                return node.hasAttribute(key);
            }

            static void pythonSetAttributes(karabo::util::Hash::Node& node, const bp::object& obj) {
            ...
            static bp::object pythonGetAttributes(karabo::util::Hash::Node& node) {
                return bp::object(node.getAttributes());
            }

            static bp::object pythonGetType(karabo::util::Hash::Node& node) {
                using namespace karabo::util;
                return bp::str(Types::to<ToLiteral>(node.getType()));
            }
            
            static void pythonSetType(karabo::util::Hash::Node& node, const std::string& type) {
                using namespace karabo::util;
