...
class DisplayPyCode(DisplayWidget):
    ...
    def __init__(self, box, parent):
        ...
        self.__tbTogglePanel.setIcon(icons.configure)
        self.__tbTogglePanel.setEnabled(True)
        # Use action for button to reuse
        self.__acTogglePanel = QAction(icons.configure, text, self)
        ...
        self.__tbExecute.setIcon(icons.refresh)
        self.__tbExecute.setEnabled(True)
        # Use action for button to reuse
        self.__acExecute = QAction(icons.refresh, text, self)
        ...
        self.__tbStop.setIcon(icons.stop)
        self.__tbStop.setEnabled(False)
        # Use action for button to reuse
        self.__acStop = QAction(icons.stop, text, self)
