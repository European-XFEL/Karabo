...
from karabo_gui import displaywidgets as widgetspkg
...
# XXX: The SVG file is in the old displaywidgets package
DEFAULT_ICON_PATH = op.join(op.dirname(widgetspkg.__file__), 'empty.svg')
