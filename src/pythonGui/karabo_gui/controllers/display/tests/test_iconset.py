...
from karabo_gui import icons as iconspkg
...
class TestDisplayIconset(GuiTestCase):
    ...
    def test_actions(self):
        ...
        sym = 'karabo_gui.controllers.display.iconset.getOpenFileName'
        ...
        sym = 'karabo_gui.controllers.display.iconset.QInputDialog'
