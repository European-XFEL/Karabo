...
def create_object_from_model(layout, model, scene_view_inner, object_dict):
    ...
    if obj is None:
        ...
        if factory:
            obj = factory(model, scene_view_inner)
    ...
    if obj is not None:
        ...
        if is_layout(obj):
            # recurse
            fill_root_layout(obj, model, scene_view_inner, object_dict)
...
def fill_root_layout(layout, parent_model, scene_view_inner, object_dict):
    ...
    for child_model in parent_model.children:
        create_object_from_model(layout, child_model, scene_view_inner,
                                 object_dict)
