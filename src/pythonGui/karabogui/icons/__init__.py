...
mediaBackward = Icon("Media-skip-backward.svg")
mediaPause = Icon("Media-playback-pause.svg")
mediaRecord = Icon("Media-record.svg")
mediaStart = Icon("Media-playback-start.svg")
mediaStop = Icon("Media-playback-stop.svg")
