...
#ifndef KARABO_DATA_TYPES_EXCEPTION_HH
#define KARABO_DATA_TYPES_EXCEPTION_HH
...
#define KARABO_PROPAGATED_EXCEPTION(msg) \
    karabo::data::PropagatedException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)

        // Convenience defines
#define KARABO_RETHROW karabo::data::Exception::rethrow(KARABO_PROPAGATED_EXCEPTION(""));
#define KARABO_RETHROW_MSG(msg) karabo::data::Exception::rethrow(KARABO_PROPAGATED_EXCEPTION(msg));
#define KARABO_RETHROW_AS(exception) karabo::data::Exception::rethrow(exception);
...
#define KARABO_PARAMETER_EXCEPTION(msg) \
    karabo::data::ParameterException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_LOGIC_EXCEPTION(msg) karabo::data::LogicException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_NOT_IMPLEMENTED_EXCEPTION(msg) \
    karabo::data::NotImplementedException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_NOT_SUPPORTED_EXCEPTION(msg) \
    karabo::data::NotSupportedException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_SCHEMA_EXCEPTION(msg) karabo::data::SchemaException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_CAST_EXCEPTION(msg) karabo::data::CastException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_IMAGE_EXCEPTION(msg) karabo::data::ImageException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
        };
...
#define KARABO_IMAGE_DIMENSION_EXCEPTION(msg) \
    karabo::data::ImageDimensionException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_IMAGE_FORMAT_EXCEPTION(msg) \
    karabo::data::ImageFormatException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_IMAGE_TYPE_EXCEPTION(msg) \
    karabo::data::ImageTypeException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_INIT_EXCEPTION(msg) karabo::data::InitException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_MEMORY_INIT_EXCEPTION(msg) \
    karabo::data::MemoryInitException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_IO_EXCEPTION(msg) karabo::data::IOException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_SYSTEM_EXCEPTION(msg) karabo::data::SystemException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_HDF_IO_EXCEPTION(msg) karabo::data::HdfIOException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_FILENOTFOUND_IO_EXCEPTION(msg) \
    karabo::data::FileNotFoundIOException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_MESSAGE_EXCEPTION(msg) karabo::data::MessageException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_PYTHON_EXCEPTION(msg) karabo::data::PythonException(msg, "", __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
#define KARABO_PYTHON_EXCEPTION2(msg, details) \
    karabo::data::PythonException(msg, details, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_CUDA_EXCEPTION(msg) karabo::data::CudaException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_HARDWARE_EXCEPTION(msg) karabo::data::HardwareException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_RECONFIGURE_EXCEPTION(msg) \
    karabo::data::ReconfigureException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_SIGNALSLOT_EXCEPTION(msg) \
    karabo::data::SignalSlotException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_NETWORK_EXCEPTION(msg) karabo::data::NetworkException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_TIMEOUT_EXCEPTION(msg) karabo::data::TimeoutException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_DOOCS_EXCEPTION(msg) karabo::data::DoocsException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)
...
#define KARABO_LOCK_EXCEPTION(msg) karabo::data::LockException(msg, __FILE__, BOOST_CURRENT_FUNCTION, __LINE__)

    } // namespace data

} // namespace karabo

#endif /* KARABO_DATA_TYPES_EXCEPTION_HH */
