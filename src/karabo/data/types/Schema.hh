...
#ifndef KARABO_DATA_TYPES_SCHEMA_HH
#define KARABO_DATA_TYPES_SCHEMA_HH
...
#define KARABO_SCHEMA_ALLOWED_ACTIONS "allowedActions"
           ...
           public:
            ...
            /**
             * The AssemblyRules specify how the karabo::data::Configurator
           ...
           public:
            ...
            karabo::data::Hash& getParameterHash();
            ...
            void setAllowedStates(const std::string& path, const karabo::data::State& s1, const karabo::data::State& s2,
            ...
            // generic interface
            void setAllowedStates(const std::string& path, const std::vector<karabo::data::State>& value);
            ...
            bool aliasHasKey(const AliasType& alias) const {
                return (m_aliasToKey.find(karabo::data::toString(alias)) != m_aliasToKey.end());
            }
            ...
            const std::string& getKeyFromAlias(const AliasType& alias) const {
                return (m_aliasToKey.find(karabo::data::toString(alias)))->second;
            }
            ...
            void setAlias(const std::string& path, const AliasType& value) {
                m_aliasToKey[karabo::data::toString(value)] = path;
...
#endif /* KARABO_DATA_TYPES_MASTERCONFIG_HH */
