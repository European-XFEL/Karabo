...
#ifndef KARABO_DATA_TYPES_CLASSINFO_HH
#define KARABO_DATA_TYPES_CLASSINFO_HH
...
#define KARABO_CLASSINFO(className, classId, classVersion)                             \
    static karabo::data::ClassInfo classInfo() {                                       \
        return karabo::data::ClassInfo(classId, BOOST_CURRENT_FUNCTION, classVersion); \
    }                                                                                  \
    virtual karabo::data::ClassInfo getClassInfo() const {                             \
        return classInfo();                                                            \
    }                                                                                  \
