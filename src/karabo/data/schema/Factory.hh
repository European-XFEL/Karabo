...
#define KARABO_REGISTER_IN_FACTORY(abstractClass, concreteClass)     \
    template <>                                                      \
    const karabo::data::FactoryMember0<abstractClass, concreteClass> \
          karabo::data::Register0<abstractClass, concreteClass>::registerAs(1);

#define KARABO_REGISTER_IN_FACTORY_AS(abstractClass, concreteClass, factoryKey) \
    template <>                                                                 \
    const karabo::data::FactoryMember0<abstractClass, concreteClass>            \
          karabo::data::Register0<abstractClass, concreteClass>::registerAs(factoryKey);

#define KARABO_REGISTER_IN_FACTORY_1(abstractClass, concreteClass, argType1)   \
    template <>                                                                \
    const karabo::data::FactoryMember1<abstractClass, concreteClass, argType1> \
          karabo::data::Register1<abstractClass, concreteClass, argType1>::registerAs(1);
...
#define KARABO_REGISTER_FACTORY_BASE_CLASS(className)
#else
#define KARABO_REGISTER_FACTORY_BASE_CLASS(className) extern template class karabo::data::Factory<className>;
#endif
#endif
