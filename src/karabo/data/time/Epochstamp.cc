...
namespace karabo {
    namespace data {
        ...
        Epochstamp::Epochstamp(const std::string& pTime) {
            karabo::data::DateTimeString dts = karabo::data::DateTimeString(pTime);
        ...
        const To Epochstamp::concatDateTimeWithFractional(const PT1 dateTime, const TIME_UNITS precision) const {
            ...
            oss << dateTime << karabo::data::DateTimeString::fractionalSecondToString(precision, m_fractionalSeconds);
        ...
        std::string Epochstamp::toFormattedStringInternal(const std::string& localeName, const std::string& fm,
            ...
            if (!noFractional) {
                dateTime += karabo::data::DateTimeString::fractionalSecondToString(MICROSEC, m_fractionalSeconds);
            }
