...
KARABO_REGISTER_FOR_CONFIGURATION_1(Base_N, Sub1_N<Base_N>); 
KARABO_REGISTER_FOR_CONFIGURATION_1(Base_N, Sub1_Y<Base_N>);  
KARABO_REGISTER_FOR_CONFIGURATION_1(Base_Y, Sub1_N<Base_Y>);
KARABO_REGISTER_FOR_CONFIGURATION_1(Base_Y, Sub1_Y<Base_Y>); 
