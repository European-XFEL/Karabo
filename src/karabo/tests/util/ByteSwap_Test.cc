...
void ByteSwap_Test::test16() {
    ...
    CPPUNIT_ASSERT(bswap16(0x1234) == (uint16_t)0x3412);

}

void ByteSwap_Test::test32() {
    
    CPPUNIT_ASSERT(bswap32(0x12345678) == (uint32_t)0x78563412);

}

void ByteSwap_Test::test64() {
    
    CPPUNIT_ASSERT(bswap64(0x1234567890ABCDEF) == (uint64_t)0xEFCDAB9078563412);
