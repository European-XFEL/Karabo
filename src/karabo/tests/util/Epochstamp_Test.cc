...
bool Epochstamp_Test::isValidIso8601(const std::string& pTimeStr) {
    karabo::util::Epochstamp t = karabo::util::Epochstamp();
    return t.isStringValidIso8601(pTimeStr);
}


void Epochstamp_Test::isStringValidIso8601() {
    /*
...
bool Epochstamp_Test::isValidKaraboIso8601(const std::string& pTimeStr) {
    karabo::util::Epochstamp t = karabo::util::Epochstamp();
    return t.isStringKaraboValidIso8601(pTimeStr);
}


void Epochstamp_Test::isStringKaraboValidIso8601() {
    /*
     * Strings that should be valid
     */
...
void Epochstamp_Test::testStrToEpochstamp() {
    ...
    // Validate other "string" constructor
    std::string pTimeStr03 = "2012-12-25T13:25:36.123456789123456789Z";
    ...
    // Validate other "string" constructor
    std::string pTimeStr04 = "2012-12-25T13:25:36,123456789123456789z";
    karabo::util::Epochstamp t07 = karabo::util::Epochstamp(pTimeStr04);
    const karabo::util::Epochstamp t08 = karabo::util::Epochstamp::fromIso8601(pTimeStr04);

    CPPUNIT_ASSERT(t07.getSeconds() == t08.getSeconds());
    CPPUNIT_ASSERT(t07.getFractionalSeconds() == t08.getFractionalSeconds());
}
...
void Epochstamp_Test::testStrToEpochstampExternal() {
    ...
    // Validate other "string" constructor
    std::string pTimeStr03 = "2012-12-25T13:25:36.123";
    karabo::util::Epochstamp t05 = karabo::util::Epochstamp(pTimeStr03);
