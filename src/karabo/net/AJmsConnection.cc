/*
 * $Id: AJmsConnection.cc 3525 2011-05-17 13:53:17Z heisenb@DESY.DE $
 *
 * File:   AJmsConnection.cc
...
namespace karabo {
    namespace net {
        ...
        void AJmsConnection::expectedParameters(Schema& expected) {
        ...
        void AJmsConnection::onException(const MQConnectionHandle connectionHandle, MQStatus status, void* callbackData) {
        ...
        void AJmsConnection::setConnectionProperties(const MQPropertiesHandle& propertiesHandle) {
        ...
        Channel::Pointer AJmsConnection::createChannel() {
            Channel::Pointer channel(new JmsChannel(*this));
