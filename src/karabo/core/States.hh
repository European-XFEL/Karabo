...
namespace karabo {
    namespace core {
        ...
        public:
            ...
            State() : m_stateName(""), m_parentState(""), m_id(0) {
            }

            State(const std::string& stateName) : m_stateName(stateName), m_parentState(""), m_id(0) {
            }

            State(const std::string& stateName, const std::string& parentName);

            State(const State& o) : m_stateName(o.m_stateName), m_parentState(o.m_parentState) {
            }
            ...
            bool operator==(const State& s) const {
                return m_stateName == s.m_stateName || m_stateName == s.m_parentState || m_parentState == s.m_stateName;
            }

            bool operator==(const std::string& s) const {
                return m_stateName == s || m_parentState == s;
            }
        ...
        protected:
            ...
            std::string m_parentState;
            size_t m_id;
        };

//    static karabo::util::ClassInfo classInfo() { return karabo::util::ClassInfo(#X, BOOST_CURRENT_FUNCTION, "1.0"); } \
//    virtual karabo::util::ClassInfo getClassInfo() const { return classInfo(); } \
//    typedef X Self; \
//    typedef boost::shared_ptr<X> Pointer; \
//    typedef boost::shared_ptr<const X> ConstPointer;
