...
#ifndef KARABO_CORE_DATALOGGERDEVICE_HH
#define	KARABO_CORE_DATALOGGERDEVICE_HH
...
namespace karabo {
    ...
    namespace core {
        ...
        class DataLoggerDevice : public Device<OkErrorFsm> {
        ...
        public:
            ...
            KARABO_CLASSINFO(DataLoggerDevice, "DataLoggerDevice", "1.0")

            static void expectedParameters(karabo::util::Schema& expected);

            DataLoggerDevice(const karabo::util::Hash& input);

            virtual ~DataLoggerDevice();
