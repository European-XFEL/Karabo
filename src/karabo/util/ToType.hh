...
#define _KARABO_HELPER_MACRO(ReferenceType) case Types::ReferenceType: return Impl::template to < Types::ReferenceType > ();
            ...
            static ReturnType to(const Types::ReferenceType& type) {
                switch (type) {
                        ...
                        _KARABO_HELPER_MACRO(NDARRAY_BOOL)
                        _KARABO_HELPER_MACRO(NDARRAY_INT8)
                        _KARABO_HELPER_MACRO(NDARRAY_UINT8)
                        _KARABO_HELPER_MACRO(NDARRAY_INT16)
                        _KARABO_HELPER_MACRO(NDARRAY_UINT16)
                        _KARABO_HELPER_MACRO(NDARRAY_INT32)
                        _KARABO_HELPER_MACRO(NDARRAY_UINT32)
                        _KARABO_HELPER_MACRO(NDARRAY_INT64)
                        _KARABO_HELPER_MACRO(NDARRAY_UINT64)
                        _KARABO_HELPER_MACRO(NDARRAY_FLOAT)
                        _KARABO_HELPER_MACRO(NDARRAY_DOUBLE)
