...
#ifndef EXFEL_UTIL_SHAPE_HH
#define	EXFEL_UTIL_SHAPE_HH
...
namespace exfel {
  namespace util {
    ...
    public:
      ...
      EXFEL_CLASSINFO(ConfigurableShape, "Shape", "1.0")
...
EXFEL_REGISTER_FACTORY_BASE_HH(exfel::util::ConfigurableShape, TEMPLATE_UTILTEST, DECLSPEC_UTILTEST)
