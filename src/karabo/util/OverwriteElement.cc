...
namespace karabo{
    namespace util{
        OverwriteElement::OverwriteElement(Schema& expected) : m_schema(&expected) {
            ...
            OverwriteElement& OverwriteElement::setNewOptions(const karabo::util::State& s1, const karabo::util::State& s2, const karabo::util::State& s3) {
                const karabo::util::State arr[] = {s1, s2, s3};
                return setNewOptions(std::vector<karabo::util::State>(arr, arr + 3));
            }

            OverwriteElement& OverwriteElement::setNewOptions(const karabo::util::State& s1, const karabo::util::State& s2, const karabo::util::State& s3, const karabo::util::State& s4) {
                const karabo::util::State arr[] = {s1, s2, s3, s4};
                return setNewOptions(std::vector<karabo::util::State>(arr, arr + 4));
            }

            OverwriteElement& OverwriteElement::setNewOptions(const karabo::util::State& s1, const karabo::util::State& s2, const karabo::util::State& s3, const karabo::util::State& s4, const karabo::util::State& s5) {
                const karabo::util::State arr[] = {s1, s2, s3, s4, s5};
                return setNewOptions(std::vector<karabo::util::State>(arr, arr + 5));
            }

            OverwriteElement& OverwriteElement::setNewOptions(const karabo::util::State& s1, const karabo::util::State& s2, const karabo::util::State& s3, const karabo::util::State& s4, const karabo::util::State& s5, const karabo::util::State& s6) {
                const karabo::util::State arr[] = {s1, s2, s3, s4, s5, s6};
                return setNewOptions(std::vector<karabo::util::State>(arr, arr + 6));
            }

            OverwriteElement& OverwriteElement::setNewOptions(const karabo::util::State& s1, const karabo::util::State& s2, const karabo::util::State& s3, const karabo::util::State& s4, const karabo::util::State& s5, const karabo::util::State& s6, const karabo::util::State& s7) {
                const karabo::util::State arr[] = {s1, s2, s3, s4, s5, s6, s7};
                return setNewOptions(std::vector<karabo::util::State>(arr, arr + 7));
            }

            OverwriteElement& OverwriteElement::setNewOptions(const karabo::util::State& s1, const karabo::util::State& s2, const karabo::util::State& s3, const karabo::util::State& s4, const karabo::util::State& s5, const karabo::util::State& s6, const karabo::util::State& s7, const karabo::util::State& s8) {
            ...
            OverwriteElement& OverwriteElement::setNewAllowedStates(const karabo::util::State& s1, const karabo::util::State& s2) {
                const karabo::util::State arr[] = {s1, s2};
                return setNewAllowedStates(std::vector<karabo::util::State>(arr, arr + 2));
            }

            OverwriteElement& OverwriteElement::setNewAllowedStates(const karabo::util::State& s1, const karabo::util::State& s2, const karabo::util::State& s3) {
                const karabo::util::State arr[] = {s1, s2, s3};
                return setNewAllowedStates(std::vector<karabo::util::State>(arr, arr + 3));
            }

            OverwriteElement& OverwriteElement::setNewAllowedStates(const karabo::util::State& s1, const karabo::util::State& s2, const karabo::util::State& s3, const karabo::util::State& s4) {
                const karabo::util::State arr[] = {s1, s2, s3, s4};
                return setNewAllowedStates(std::vector<karabo::util::State>(arr, arr + 4));
            }

            OverwriteElement& OverwriteElement::setNewAllowedStates(const karabo::util::State& s1, const karabo::util::State& s2, const karabo::util::State& s3, const karabo::util::State& s4, const karabo::util::State& s5) {
                const karabo::util::State arr[] = {s1, s2, s3, s4, s5};
                return setNewAllowedStates(std::vector<karabo::util::State>(arr, arr + 5));
            }

            OverwriteElement& OverwriteElement::setNewAllowedStates(const karabo::util::State& s1, const karabo::util::State& s2, const karabo::util::State& s3, const karabo::util::State& s4, const karabo::util::State& s5, const karabo::util::State& s6) {
                const karabo::util::State arr[] = {s1, s2, s3, s4, s5, s6};
