...
namespace karabo {
    namespace util {
        ...
        class InputElement : public GenericElement<InputElement> {

            Schema::AssemblyRules m_parentSchemaAssemblyRules;

            DefaultValue<InputElement, std::string> m_defaultValue;
        public:

            InputElement(Schema& expected) : GenericElement<InputElement>(expected) {
