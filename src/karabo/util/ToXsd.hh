...
namespace karabo {
    namespace util {
        ...
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, VECTOR_CHAR, "xs:byte")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, INT8, "xs:byte")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, VECTOR_INT8, "xs:byte")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, UINT8, "xs:unsignedByte")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, VECTOR_UINT8, "xs:unsignedByte")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, INT16, "xs:short")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, VECTOR_INT16, "xs:short")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, UINT16, "xs:unsignedShort")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, VECTOR_UINT16, "xs:unsignedShort")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, INT32, "xs:int")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, VECTOR_INT32, "xs:int")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, UINT32, "xs:unsignedInt")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, VECTOR_UINT32, "xs:unsignedInt")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, INT64, "xs:long")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, VECTOR_INT64, "xs:long")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, UINT64, "xs::unsignedLong")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, VECTOR_UINT64, "xs::unsignedLong")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, FLOAT, "xs:float")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, VECTOR_FLOAT, "xs:float")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, DOUBLE, "xs:double")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, VECTOR_DOUBLE, "xs:double")
        ...
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, VECTOR_COMPLEX_FLOAT, "xs:float")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, COMPLEX_DOUBLE, "xs:double")
        KARABO_MAP_TO_REFERENCE_TYPE(ToXsd, VECTOR_COMPLEX_DOUBLE, "xs:double")
