...
namespace karabo {
    namespace util {
        ...
        public:
             ...
             * @return reference to the Element (to allow method's chaining)
             */
            Derived& allowedStates(const std::vector<karabo::core::State>& value) {
            ...
            Derived& allowedStates(const karabo::core::State& s1) {
                const karabo::core::State arr[] = {s1};
                return allowedStates(std::vector<karabo::core::State>(arr, arr+1));
            }
            
            Derived& allowedStates(const karabo::core::State& s1, const karabo::core::State& s2) {
                const karabo::core::State arr[] = {s1, s2};
                return allowedStates(std::vector<karabo::core::State>(arr, arr+2));
            }
            
            Derived& allowedStates(const karabo::core::State& s1, const karabo::core::State& s2, const karabo::core::State& s3) {
                const karabo::core::State arr[] = {s1, s2, s3};
                return allowedStates(std::vector<karabo::core::State>(arr, arr+3));
            }
            
            Derived& allowedStates(const karabo::core::State& s1, const karabo::core::State& s2, const karabo::core::State& s3, const karabo::core::State& s4) {
                const karabo::core::State arr[] = {s1, s2, s3, s4};
                return allowedStates(std::vector<karabo::core::State>(arr, arr+4));
            }
            
            Derived& allowedStates(const karabo::core::State& s1, const karabo::core::State& s2, const karabo::core::State& s3, const karabo::core::State& s4, const karabo::core::State& s5) {
                const karabo::core::State arr[] = {s1, s2, s3, s4, s5};
                return allowedStates(std::vector<karabo::core::State>(arr, arr+5));
            }
            
            Derived& allowedStates(const karabo::core::State& s1, const karabo::core::State& s2, const karabo::core::State& s3, const karabo::core::State& s4, const karabo::core::State& s5, const karabo::core::State& s6) {
                const karabo::core::State arr[] = {s1, s2, s3, s4, s5, s6};
                return allowedStates(std::vector<karabo::core::State>(arr, arr+6));
            }
