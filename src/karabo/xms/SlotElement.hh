    ...
    namespace xms {
        ...
        public:
            ...
            SlotElementBase(karabo::util::Schema& expected) : karabo::util::GenericElement<Derived>(expected) {
                ...
                m_child.setAttribute<int>("connectedSignals", "expertLevel", Schema::ADVANCED);
                m_child.setAttribute<int>("connectedSignals", "assignment", Schema::OPTIONAL_PARAM);
                m_child.setAttribute<int>("connectedSignals", "nodeType", Schema::LEAF);
            }
            ...
            Derived& connectionAssignmentIsMandatory() {
                m_child.setAttribute<int>("connectedSignals", "assignment", Schema::MANDATORY_PARAM);
                return *(static_cast<Derived*> (this));
            }
            ...
            Derived& connectionsAreNotReconfigurable() {
                m_child.setAttribute<int>("connectedSignals", "accessMode", INIT);
                return *(static_cast<Derived*> (this));
            }

            Derived& connectionsAreReconfigurable() {
                m_child.setAttribute<int>("connectedSignals", "accessMode", WRITE);
                return *(static_cast<Derived*> (this));
            }
        ...
        public:
            ...
            SLOT_ELEMENT1(karabo::util::Schema& expected) : SlotElementBase<SLOT_ELEMENT1<A1> >(expected) {
                m_child.set("arg1", 0);
                m_child.setAttribute("arg1", "displayedName", "Argument 1");
                m_child.setAttribute<int>("arg1", "accessMode", WRITE);
                m_child.setAttribute<int>("arg1", "assignment", Schema::MANDATORY_PARAM);
            }

            SLOT_ELEMENT1& arg1Description(const std::string& desc) {
                m_child.setAttribute("arg1", "description", desc);
                return *this;
            }

            SLOT_ELEMENT1& arg1DisplayName(const std::string& name) {
                m_child.setAttribute("arg1", "displayedName", name);
                return *this;
            }
