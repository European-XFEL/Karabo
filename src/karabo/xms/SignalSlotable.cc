...
namespace karabo {
    namespace xms {
        ...
        void SignalSlotable::registerDefaultSignalsAndSlots() {
            ...
            KARABO_SLOT1(slotGetOutputChannelInformationFromHash, karabo::util::Hash /*hash*/)  // wrapper for GUI server generic calls
    ...
    void SignalSlotable::slotDisconnectFromSignal(const std::string& signalFunction, const std::string& slotInstanceId, const std::string& slotFunction) {
        ...
        void SignalSlotable::connectInputChannelHandler_old(const InputChannel::Pointer& inChannel, const std::string& outputChannelString,
            ...
            if (outChannelExists) {
                ...
                KARABO_LOG_FRAMEWORK_ERROR << getInstanceId() << " could not connect outputChannel '" << outputChannelString
                        << "' since its instance has no such channel.";
            }
        }
        ...
        std::pair<bool, karabo::util::Hash> SignalSlotable::slotGetOutputChannelInformationImpl(const std::string& ioChannelId, const int& processId) {
            boost::mutex::scoped_lock lock(m_pipelineChannelsMutex);
        ...
        void SignalSlotable::slotGetOutputChannelInformation(const std::string& ioChannelId, const int& processId) {
            const std::pair<bool, karabo::util::Hash>& result = slotGetOutputChannelInformationImpl(ioChannelId, processId);
        ...
        void SignalSlotable::slotGetOutputChannelInformationFromHash(const karabo::util::Hash& hash) {
            const std::pair<bool, karabo::util::Hash>& result = slotGetOutputChannelInformationImpl(hash.get<std::string>("ioChannelId"), hash.get<int>("processId"));
