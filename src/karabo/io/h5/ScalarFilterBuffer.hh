...
namespace karabo {
    ...
    namespace io {
        ...
        namespace h5 {
            ...
            class ScalarFilterBuffer :
            public karabo::io::h5::ScalarFilter<T> {
            public:

                KARABO_CLASSINFO(ScalarFilterBuffer, typeid (CONT<T>).name(), "1.0")
            ...
            public karabo::io::h5::ScalarFilter<std::string> {
            public:
