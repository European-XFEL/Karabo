        ...
        namespace h5 {
            ...
            class Scalar : public U/*karabo::io::h5::Dataset*/ {
                ...
                static const std::string suffix(const Dataset*) {
                    return karabo::util::ToType<karabo::util::ToLiteral>::
                            to(karabo::util::FromType<karabo::util::FromTypeInfo>::from(typeid (T)));
            ...
            public:
                ...
                void writeNode1(const HASH_ELEMENT& node, hid_t dataSet, hid_t fileDataSpace) {
                    ...
                    try {
                        ...
                        KARABO_RETHROW_AS(KARABO_PROPAGATED_EXCEPTION("Cannot write Hash node " + this->m_key + " to dataset /" + this->m_h5PathName));
                    }
                }
