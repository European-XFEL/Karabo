...
#define _LOGGER_CATEGORY "karabo.io.h5.DatasetWriter"
            ...
            private:
                ...
                template<class HASH_ELEMENT>
                inline void writeHashElement(const HASH_ELEMENT& node, hsize_t len, hid_t dataSet, hid_t fileDataSpace) {
            ...
            */
            ...
            template<>
            template<class HASH_ELEMENT>
            inline void DatasetScalarWriter<bool>::writeHashElement(const HASH_ELEMENT& node, hid_t dataSet, hid_t fileDataSpace) {
            ...
            template<>
            template<class HASH_ELEMENT>
            inline void DatasetScalarWriter<bool>::writeHashElement(const HASH_ELEMENT& node, hsize_t len, hid_t dataSet, hid_t fileDataSpace) {
            ...
            template<>
            template<class HASH_ELEMENT>
            inline void DatasetVectorWriter<bool>::writeHashElement(const HASH_ELEMENT& node, hid_t dataSet, hid_t fileDataSpace) {
            ...
            template<>
            template<class HASH_ELEMENT>
            inline void DatasetVectorWriter<bool>::writeHashElement(const HASH_ELEMENT& node, hsize_t len, hid_t dataSet, hid_t fileDataSpace) {
            ...
            template<>
            template<class HASH_ELEMENT>
            inline void DatasetPointerWriter<bool>::writeHashElement(const HASH_ELEMENT& node, hid_t dataSet, hid_t fileDataSpace) {
            ...
            template<>
            template<class HASH_ELEMENT>
            inline void DatasetPointerWriter<bool>::writeHashElement(const HASH_ELEMENT& node, hsize_t len, hid_t dataSet, hid_t fileDataSpace) {
            ...
            template<>
            template<class HASH_ELEMENT>
            inline void DatasetNDArrayH5Writer<bool>::writeHashElement(const HASH_ELEMENT& node, hid_t dataSet, hid_t fileDataSpace) {
                KARABO_LOG_FRAMEWORK_TRACE_C(_LOGGER_CATEGORY) << "entered write(bool, ptr)";
            ...
            template<>
            template<class HASH_ELEMENT>
            inline void DatasetNDArrayH5Writer<bool>::writeHashElement(const HASH_ELEMENT& node, hsize_t len, hid_t dataSet, hid_t fileDataSpace) {
                KARABO_LOG_FRAMEWORK_TRACE_C(_LOGGER_CATEGORY) << "entered write(bool, ptr, buffer)";
            ...
            */
            ...
            template<>
            template<class HASH_ELEMENT>
            inline void DatasetScalarWriter<std::string>::writeHashElement(const HASH_ELEMENT& node, hid_t dataSet, hid_t fileDataSpace) {
            ...
            template<>
            template<class HASH_ELEMENT>
            inline void DatasetScalarWriter<std::string>::writeHashElement(const HASH_ELEMENT& node, hsize_t len, hid_t dataSet, hid_t fileDataSpace) {
            ...
            template<>
            template<class HASH_ELEMENT>
            inline void DatasetVectorWriter<std::string>::writeHashElement(const HASH_ELEMENT& node, hid_t dataSet, hid_t fileDataSpace) {
            ...
            template<>
            template<class HASH_ELEMENT>
            inline void DatasetVectorWriter<std::string>::writeHashElement(const HASH_ELEMENT& node, hsize_t len, hid_t dataSet, hid_t fileDataSpace) {
            ...
            template<>
            template<class HASH_ELEMENT>
            inline void DatasetPointerWriter<std::string>::writeHashElement(const HASH_ELEMENT& node, hid_t dataSet, hid_t fileDataSpace) {
            ...
            template<>
            template<class HASH_ELEMENT>
            inline void DatasetPointerWriter<std::string>::writeHashElement(const HASH_ELEMENT& node, hsize_t len, hid_t dataSet, hid_t fileDataSpace) {
            ...
            template<>
            template<class HASH_ELEMENT>
            inline void DatasetNDArrayH5Writer<std::string>::writeHashElement(const HASH_ELEMENT& node, hid_t dataSet, hid_t fileDataSpace) {
                KARABO_LOG_FRAMEWORK_TRACE_C(_LOGGER_CATEGORY) << "entered write(std::string, ptr)";
            ...
            template<>
            template<class HASH_ELEMENT>
            inline void DatasetNDArrayH5Writer<std::string>::writeHashElement(const HASH_ELEMENT& node, hsize_t len, hid_t dataSet, hid_t fileDataSpace) {
                KARABO_LOG_FRAMEWORK_TRACE_C(_LOGGER_CATEGORY) << "entered write(std::string, ptr, buffer)";
