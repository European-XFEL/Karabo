/*
 * $Id: TextFileWriter.hh 4951 2012-01-06 12:54:57Z heisenb@DESY.DE $
 *
...
namespace karabo {
  ...
  namespace io {
    ...
    public:
      ...
      TextFileWriter(const std::string& filename, const std::string& writeMode, const FormatPointer& format) :
