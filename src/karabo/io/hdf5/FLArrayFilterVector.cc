...
namespace karabo {
    namespace io {
        namespace hdf5 {
            ...
            KARABO_REGISTER_FACTORY_CC(FLArrayFilter<bool>, BoolDequeFLArrayFilter)                    
           // std::vector<bool> is not supported, use instead std::deque<bool>
            ...
            KARABO_REGISTER_FACTORY_CC(DataTypes, BoolDequeFLArrayFilter)
