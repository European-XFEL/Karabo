           ...
           public:
            ...
            static void expectedParameters(karabo::util::Schema& expected) {
                ...
                STRING_ELEMENT(expected)
                      ...
                      .options("exclusive, truncate, append")
                      .assignmentOptional()
                      .defaultValue(std::string("append"))
                      .commit();
            ...
            void write(const T& data) {
                ...
                try {
                    if (m_enableAppendMode) {
                        ...
                        if (false) {
                            std::clog << std::endl;
                            std::clog << "write data                       : " << p.getPeriod("write").getDuration()
                                      << " [s]" << std::endl;
                        }
                    }
                    ...
                    KARABO_RETHROW_AS(
                          KARABO_PROPAGATED_EXCEPTION("Cannot serialize object to file " + m_filename.string()))
                }
            }
