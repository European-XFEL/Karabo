...
#ifndef EXFEL_XIP_FILEWRAPDEVICEINPUT_HH
#define	EXFEL_XIP_FILEWRAPDEVICEINPUT_HH
    ...
    namespace xip {
        ...
        public:
            ...
            void startConnection(exfel::net::Connection::Pointer connection, const std::string& instanceId, const std::string& memoryLocation) {
                //connection->setErrorHandler(&exfel::xip::FileWrapDeviceInput<std::vector<char> >::onTcpConnectionError, this, _1, _2);
                exfel::net::Channel::Pointer channel = connection->start();
                channel->setErrorHandler(boost::bind(&exfel::xip::FileWrapDeviceInput::onTcpChannelError, this, _1, _2));
                channel->write(exfel::util::Hash("instanceId", instanceId, "memoryLocation", memoryLocation)); // Say hello!
                channel->readAsyncVectorHash(boost::bind(&exfel::xip::FileWrapDeviceInput::onTcpChannelRead, this, _1, _2, _3));
