...
namespace karabo {
    namespace xip {
        ...
        KARABO_REGISTER_FOR_CONFIGURATION(karabo::io::Output<karabo::xip::CpuImage<unsigned int> >, karabo::xms::NetworkOutput<karabo::xip::CpuImage<unsigned int> >)
        KARABO_REGISTER_FOR_CONFIGURATION(karabo::io::Output<karabo::xip::CpuImage<unsigned short> >, karabo::xms::NetworkOutput<karabo::xip::CpuImage<unsigned short> >)
        KARABO_REGISTER_FOR_CONFIGURATION(karabo::io::Output<karabo::xip::CpuImage<unsigned char> >, karabo::xms::NetworkOutput<karabo::xip::CpuImage<unsigned char> >)
