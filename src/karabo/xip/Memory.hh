...
#ifndef EXFEL_XIP_MEMORY_HH
#define	EXFEL_XIP_MEMORY_HH

#include <exfel/util/Factory.hh>
#include <exfel/io/BinarySerializer.hh>
...
namespace exfel {
    namespace xip {
        ...
        template <class T>
        std::vector<bool> Memory<T>::m_channelStatus = std::vector<bool>(MAX_N_CHANNELS);
