...
KARABO_REGISTER_FOR_CONFIGURATION(karabo::core::Device, karabo::devices::DataLogReader,
        ...
        void InfluxLogReader::onLastSchemaDigestBeforeTime(const karabo::net::HttpResponse& valueResp,
            ...
            try {
                ...
                if (value.is_null()) {
                    ...
                    // Note that following text is expected in DataLogging_Test::testCfgFromPastRestart
                    std::ostringstream oss;
