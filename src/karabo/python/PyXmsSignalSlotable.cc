...
void exportPyXmsSignalSlotable() {//exposing exfel::xms::SignalSlotable 
    ...
    bp::class_<SignalSlotable, boost::noncopyable > ("SignalSlotableIntern")
            .def(bp::init<const exfel::net::BrokerConnection::Pointer&, const std::string&, int>())
            .def(bp::init<const exfel::net::BrokerConnection::Pointer&, const std::string&>())
            ;
    ...
    bp::class_<SignalSlotableWrap, bp::bases< SignalSlotable>, boost::noncopyable > ("SignalSlotable")
            ...
            .def(bp::init<const std::string&, const std::string&, const exfel::util::Hash&>())
            ...
            .def("reconfigure", (void (SignalSlotableWrap::*)(const std::string&, const exfel::util::Hash&) const)(&SignalSlotableWrap::reconfigurePy),(bp::arg("instanceId"), bp::arg("configuration")))
