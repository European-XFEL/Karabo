...
#include <exfel/xms/SlotElement.hh>
...
void exportSlotElement() {
    ...
    sl.def("allowedStates"
            , (SLOT_ELEMENT & (SlotElementBase<SLOT_ELEMENT>::*)(string const &))(&SlotElementBase<SLOT_ELEMENT >::allowedStates)
            , (bp::arg("states"))
    ...
    { //exfel::xms::SLOT_ELEMENT
        bp::class_< SLOT_ELEMENT_Wrapper, bp::bases<SlotElementBase< SLOT_ELEMENT > > > elem("SLOT_ELEMENT", bp::init< exfel::util::Schema &>(bp::arg("expected")));
