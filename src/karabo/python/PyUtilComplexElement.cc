...
void exportComplexElement() {
    ...
    complElem.def("init"
            , (ComplexElement & (ComplexElement::*)())(&::karabo::util::ComplexElement::init)
            , bp::return_internal_reference<>());

    complElem.def("initAndRead"
            , (ComplexElement & (ComplexElement::*)())(&::karabo::util::ComplexElement::initAndRead)
            , bp::return_internal_reference<>());
    ...
    complElem.def("readOnly"
            , (ComplexElement & (ComplexElement::*)())(&::karabo::util::ComplexElement::readOnly)
            , bp::return_internal_reference<>());
