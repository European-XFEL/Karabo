...
void exportPyCoreDeviceClient() {
    ...
    bp::class_<DeviceClientWrap, bp::bases<DeviceClient>, boost::noncopyable > ("DeviceClient")
            ...
            .def("instantiateWait", (void (DeviceClient::*)(const string&, const string&, const Hash&, int))(&DeviceClient::instantiateWait), (bp::arg("serverInstanceId"), bp::arg("classId"), bp::arg("configuration") = exfel::util::Hash(), bp::arg("timeout") = -1))
