...
#ifndef EXFEL_PYEXFEL_DEFAULTVALUEVECTORWRAP_HH
#define	EXFEL_PYEXFEL_DEFAULTVALUEVECTORWRAP_HH

#include <boost/python.hpp>
#include <exfel/util/GenericElement.hh>
...
namespace exfel {
    namespace pyexfel {
        ...
        public:
            ...
            typedef exfel::util::VectorElement< T, std::vector > U;
            typedef exfel::util::DefaultValue< U, VType > DefValueVec;
        ...
        public:
            ...
            typedef exfel::util::VectorElement< bool, std::deque > U;
            typedef exfel::util::DefaultValue< U, VType > DefValueVec;
...
#define EXFEL_PYTHON_VECTOR_DEFAULT_VALUE(t, e) \
{\
typedef t EType;\
...
.def("defaultValue"\
, &exfel::pyexfel::DefaultValueVectorWrap<EType>::pyList2VectorDefaultValue\
...
#endif	/* EXFEL_PYEXFEL_DEFAULTVALUEVECTORWRAP_HH */
