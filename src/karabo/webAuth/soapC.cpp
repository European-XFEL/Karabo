...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.17r 2014-01-06 13:45:38 GMT")
...
void ns1__login::soap_default(struct soap *soap)
{
	...
	this->ns1__login::brokerHostname = NULL;
	this->ns1__login::brokerPortNumber = NULL;
	this->ns1__login::brokerTopic = NULL;
...
void ns1__login::soap_serialize(struct soap *soap) const
{
	...
	soap_serialize_PointerTostd__string(soap, &this->ns1__login::brokerHostname);
	soap_serialize_PointerTostd__string(soap, &this->ns1__login::brokerPortNumber);
	soap_serialize_PointerTostd__string(soap, &this->ns1__login::brokerTopic);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__login(struct soap *soap, const char *tag, int id, const ns1__login *a, const char *type)
{
	...
	if (soap_out_PointerTostd__string(soap, "ipAddress", -1, &(a->ns1__login::ipAddress), ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "brokerHostname", -1, &(a->ns1__login::brokerHostname), ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "brokerPortNumber", -1, &(a->ns1__login::brokerPortNumber), ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "brokerTopic", -1, &(a->ns1__login::brokerTopic), ""))
		return soap->error;
...
SOAP_FMAC3 ns1__login * SOAP_FMAC4 soap_in_ns1__login(struct soap *soap, const char *tag, ns1__login *a, const char *type)
{
	...
	size_t soap_flag_brokerHostname1 = 1;
	size_t soap_flag_brokerPortNumber1 = 1;
	size_t soap_flag_brokerTopic1 = 1;
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			if (soap_flag_brokerHostname1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__string(soap, "brokerHostname", &(a->ns1__login::brokerHostname), "xsd:string"))
				{	soap_flag_brokerHostname1--;
					continue;
				}
			if (soap_flag_brokerPortNumber1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__string(soap, "brokerPortNumber", &(a->ns1__login::brokerPortNumber), "xsd:string"))
				{	soap_flag_brokerPortNumber1--;
					continue;
				}
			if (soap_flag_brokerTopic1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__string(soap, "brokerTopic", &(a->ns1__login::brokerTopic), "xsd:string"))
				{	soap_flag_brokerTopic1--;
					continue;
				}
...
void ns1__hasActiveSession::soap_default(struct soap *soap)
{
	...
	this->ns1__hasActiveSession::brokerHostname = NULL;
	this->ns1__hasActiveSession::brokerPortNumber = NULL;
	this->ns1__hasActiveSession::brokerTopic = NULL;
	/* transient soap skipped */
}
...
void ns1__hasActiveSession::soap_serialize(struct soap *soap) const
{
	...
	soap_serialize_PointerTostd__string(soap, &this->ns1__hasActiveSession::brokerHostname);
	soap_serialize_PointerTostd__string(soap, &this->ns1__hasActiveSession::brokerPortNumber);
	soap_serialize_PointerTostd__string(soap, &this->ns1__hasActiveSession::brokerTopic);
	/* transient soap skipped */
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__hasActiveSession(struct soap *soap, const char *tag, int id, const ns1__hasActiveSession *a, const char *type)
{
	...
	if (soap_out_PointerTostd__string(soap, "ipAddress", -1, &(a->ns1__hasActiveSession::ipAddress), ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "brokerHostname", -1, &(a->ns1__hasActiveSession::brokerHostname), ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "brokerPortNumber", -1, &(a->ns1__hasActiveSession::brokerPortNumber), ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "brokerTopic", -1, &(a->ns1__hasActiveSession::brokerTopic), ""))
		return soap->error;
	/* transient soap skipped */
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 ns1__hasActiveSession * SOAP_FMAC4 soap_in_ns1__hasActiveSession(struct soap *soap, const char *tag, ns1__hasActiveSession *a, const char *type)
{
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			if (soap_flag_brokerHostname1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__string(soap, "brokerHostname", &(a->ns1__hasActiveSession::brokerHostname), "xsd:string"))
				{	soap_flag_brokerHostname1--;
					continue;
				}
			if (soap_flag_brokerPortNumber1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__string(soap, "brokerPortNumber", &(a->ns1__hasActiveSession::brokerPortNumber), "xsd:string"))
				{	soap_flag_brokerPortNumber1--;
					continue;
				}
			if (soap_flag_brokerTopic1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__string(soap, "brokerTopic", &(a->ns1__hasActiveSession::brokerTopic), "xsd:string"))
				{	soap_flag_brokerTopic1--;
					continue;
				}
			/* transient soap skipped */
...
{
	this->soap = soap;
	this->ns1__xfelSession::accessList = NULL;
	this->ns1__xfelSession::defaultAccessLevelDesc = NULL;
	this->ns1__xfelSession::defaultAccessLevelId = NULL;
...
#ifndef WITH_NOIDREF
	(void)soap; /* appease -Wall -Werror */
	soap_serialize_PointerTostd__string(soap, &this->ns1__xfelSession::accessList);
	soap_serialize_PointerTostd__string(soap, &this->ns1__xfelSession::defaultAccessLevelDesc);
	soap_serialize_PointerToint(soap, &this->ns1__xfelSession::defaultAccessLevelId);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__xfelSession(struct soap *soap, const char *tag, int id, const ns1__xfelSession *a, const char *type)
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns1__xfelSession), type))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "accessList", -1, &(a->ns1__xfelSession::accessList), ""))
		return soap->error;
	if (soap_out_PointerTostd__string(soap, "defaultAccessLevelDesc", -1, &(a->ns1__xfelSession::defaultAccessLevelDesc), ""))
		return soap->error;
	if (soap_out_PointerToint(soap, "defaultAccessLevelId", -1, &(a->ns1__xfelSession::defaultAccessLevelId), ""))
		return soap->error;
...
SOAP_FMAC3 ns1__xfelSession * SOAP_FMAC4 soap_in_ns1__xfelSession(struct soap *soap, const char *tag, ns1__xfelSession *a, const char *type)
{
	...
	size_t soap_flag_accessList1 = 1;
	size_t soap_flag_defaultAccessLevelDesc1 = 1;
	size_t soap_flag_defaultAccessLevelId1 = 1;
	...
	if (soap->body && !*soap->href)
	{
		for (;;)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_accessList1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__string(soap, "accessList", &(a->ns1__xfelSession::accessList), "xsd:string"))
				{	soap_flag_accessList1--;
					continue;
				}
			if (soap_flag_defaultAccessLevelDesc1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__string(soap, "defaultAccessLevelDesc", &(a->ns1__xfelSession::defaultAccessLevelDesc), "xsd:string"))
				{	soap_flag_defaultAccessLevelDesc1--;
					continue;
				}
			if (soap_flag_defaultAccessLevelId1 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerToint(soap, "defaultAccessLevelId", &(a->ns1__xfelSession::defaultAccessLevelId), "xsd:int"))
				{	soap_flag_defaultAccessLevelId1--;
					continue;
				}
