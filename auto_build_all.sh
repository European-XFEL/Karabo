...
runIntegrationTests() {
    ...
    local testNames="AlarmService_ DeviceServerRunner_ LockTest_ PipelinedProcessing_ PropertyTest_ RunTimeSchemaAttributes_ SceneProvider_ Timing_"
...
if [[ $1 = "Release" || $1 = "Debug" ]]; then
    ...
    rm -rf dist build nbproject/Makefile* nbproject/Package* nbproject/private
    safeRunCommand "cd $scriptDir/build/netbeans/p2pMessageLogger"
    rm -rf dist build nbproject/Makefile* nbproject/Package* nbproject/private
    exit 0
