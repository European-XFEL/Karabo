...
MOCK_MODULES = [
    ...
    "tabulate", "karabogui.controllers.table.api", "aioredis",
...
project = "Karabo"
copyright = "European XFEL GmbH - Controls Group"
...
latex_documents = [
    ("index", "Karabo.tex", "Karabo Documentation",
     "European XFEL GmbH - Controls Group", "manual"),
]
...
man_pages = [
    ("index", "karabo", "Karabo Documentation",
     ["European XFEL GmbH - Controls Group"], 1)
]
...
texinfo_documents = [
    ("index", "Karabo", "Karabo Documentation",
     "European XFEL GmbH - Controls Group", "Karabo",
