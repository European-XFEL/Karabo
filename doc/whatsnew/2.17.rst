...
Preliminary! Release scheduled for the 19.05.2023. Merge-log until 2.17.0rc5.
...
- Device servers (scriptMDL): Can be started with serverFlags description (Enum)
...
- MDL: slotGetConfiguration does not contain `Slots` as keys
