...
readable format (20160322T132225.584706Z) and once as a double variable
counting the seconds of the Unix epoch (1458652945.584706). Before, the Unix
epoch was also given as two integer number, one for the seconds, one counting
...
the data logger server, usually resulting in
``karaboRun/servers/dataLoggerServer/karaboHistory``.
The new default is one directory up i.e. ``../karaboHistory``.
This will usually result in ``karaboRun/servers/karaboHistory``
This change will make it much easier to change the number of data logger
servers in an existing system.
