...
All notable changes are until **3.0.0rc11**
...
- Session Management for Authentication:
  ...
  - Client Sessions are automatically logged out after 14 days if they don't relogin
...
- Schema Elements with AccessMode `INITONLY` are currently rewritten as `RECONFIGURABLE`. This gives a warning. In future this will throw. Note that bound api
  default is `INITONLY`.
