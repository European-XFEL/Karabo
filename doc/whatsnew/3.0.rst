...
- Refactored project database to use SQLite
- Refactored configuration database to use MySQL
...
- AccessLevel Update: `USER` and `ADMIN` levels have been removed. Use `OPERATOR` and `EXPERT` instead.
-
...
- Element and Enum Removals or Changes:
  ...
  - Removes `Image Element` properties `dimScales` and `dimTyes`
