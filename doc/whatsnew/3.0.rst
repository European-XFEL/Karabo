...
- *(Bound)* Bindings for registerDeviceForMonitoring (Cherry-pick hotfix 3.0.X) ([ed7fea8](https://git.xfel.eu/Karabo/Framework/-/commit/ed7fea8bb8be6028654d4c4bcf764603c9008edd))
- *(GUI)* Check if the name exists in project before server edit (Cherry-pick hotfix 3.0.X) ([eaa8d36](https://git.xfel.eu/Karabo/Framework/-/commit/eaa8d366d2712d940fe809b4152a5fc22b3f7b04))
- *(GUI)* Install GUIExtension using the correct system executable (Cherry-pick hotfix 3.0.X) ([da1d0a0](https://git.xfel.eu/Karabo/Framework/-/commit/da1d0a06bbffcde913d1f82f2da401eb3843dd48))
- *(GUI)* Login information - Show the remaining time as integer (Cherry-pick hotfix 3.0.X) ([50dea3b](https://git.xfel.eu/Karabo/Framework/-/commit/50dea3b9eea0353bbaebac7a910902ea1d0796bf))

Features
++++++++

- *(GUI)* Allow to register scene handler on run time (Cherry-pick hotfix 3.0.X) ([8435a68](https://git.xfel.eu/Karabo/Framework/-/commit/8435a682398e43176cf00efd5fe8644b1753297e))
- *(GUI)* Increase default hight of the plots(Cherry-pick hotfix 3.0.X) ([dee86f7](https://git.xfel.eu/Karabo/Framework/-/commit/dee86f71742b58751dda0b3d3bc8c1d396370049))

Deps
++++

- *(No Category)* Update conan to latest version (Cherry-pick hotfix) ([d46deff](https://git.xfel.eu/Karabo/Framework/-/commit/d46deffd90e5257174957df5fd166227d1b5a921))


**************************
What's New in Karabo 3.0.8
**************************
...
- *(C++)* "status" property update triggered sending of full config to gui clients (Backport 3.0.X) ([00a9276](https://git.xfel.eu/Karabo/Framework/-/commit/00a9276bdebfba31483fcee084d982a135d42ee2))
- *(C++ tests)* Systematic sleep before eventloop stop to avoid that thread joining hangs (Backport 3.0.X) ([7902fcc](https://git.xfel.eu/Karabo/Framework/-/commit/7902fcc9237100b22d85eff3937573e364dfd451))
- *(MDL)* Always reply to slotDiscover even when not broadcast (Cherry-pick hotfix 3.X) ([d5db70e](https://git.xfel.eu/Karabo/Framework/-/commit/d5db70ed9e3dab4f3be5543cf0d5f351486ab85b))

Features
++++++++

- *(GUI)* Increase user experience in project find dialog, allow 4 chars only and update status (cherry-pick hotfix) ([eec10b2](https://git.xfel.eu/Karabo/Framework/-/commit/eec10b2274d4516e886eb3481c78420eb7e456b8))

**************************
What's New in Karabo 3.0.7
**************************

Released on **September 29th, 2025**.

Bug Fixes
+++++++++

- *(Bound)* PythonDevice.appendSchemaMaxSize may have to recreate output channels (Backport 3.0.x) ([32dc216](https://git.xfel.eu/Karabo/Framework/-/commit/32dc216b2b29cc65f33fb62da33417ae75c83da1))
- *(C++)* Proper argument to slotDiscover (Backport to 3.0.X) ([0f0f4bf](https://git.xfel.eu/Karabo/Framework/-/commit/0f0f4bf04aa76feeb1df0b2e4116cba4d9797fa3))
- *(C++)* Device::appendSchemaMaxSize has to recreate touched output channels (Backport to 3.0.X) ([191e577](https://git.xfel.eu/Karabo/Framework/-/commit/191e577699dc5bfc0baf3000151fa89f9c1c940c))
- *(C++/Bound)* Accept more characters for properties if tolerance is requested (Backport 3.0.X) ([2ae37fe](https://git.xfel.eu/Karabo/Framework/-/commit/2ae37fef8f2c299c000a9fe755a3ea046b43ed26))
- *(GUI)* Fix scene attachment to project (Cherry-pick hotfix) ([2e309c7](https://git.xfel.eu/Karabo/Framework/-/commit/2e309c7f357467e9278bb91e02871afc8346805a))

Features
++++++++

- *(GUI)* Configurator shows properties for offline proxy, if not reconfigurable via access level (Cherry-pick hotfix) ([2ca3858](https://git.xfel.eu/Karabo/Framework/-/commit/2ca3858ff8f5fae96d1a2b0ae16a490b4b6603ef))


**************************
What's New in Karabo 3.0.6
**************************

This release was deleted due to broken CI/Dependencies.

**************************
What's New in Karabo 3.0.5
**************************
...
- *(C++)* No internal signals anymore and fix instanceUpdate patch (Backport to 3.0.X) ([a4f45a5](https://git.xfel.eu/Karabo/Framework/-/commit/a4f45a5fb3c308d73541788d98912cffdecda02b))

Refactor
++++++++

- *(Bound/C++)* Allow @ as part of a karabo key (Cherry-pick hotfix) ([ba78a39](https://git.xfel.eu/Karabo/Framework/-/commit/ba78a39b53287d8439fb6a11acb0d074db752471))


**************************
What's New in Karabo 3.0.4
**************************
...
- *(C++)* Exclusive AMQP queue (backport 3.0.X) ([dc01907](https://git.xfel.eu/Karabo/Framework/-/commit/dc01907ecd2e80d4e2d263d481eb554813fbf10a))
- *(DOC)* Remove alarm system remnant from C++/Bound alarm condition description (Backport 3.0.X) ([e48a1d8](https://git.xfel.eu/Karabo/Framework/-/commit/e48a1d8d7b3220703d471bd5d2c8e2ab1cb6a23c))
- *(No Category)* Db user for the internal office project DB (Cherry-pick 3.0.X) ([57b2633](https://git.xfel.eu/Karabo/Framework/-/commit/57b26339c9d69ab9d1780d5b081015e89b59d305))

Refactor
++++++++

- *(MDL)* Use non durable exclusive queues (Cherry-pick hotfix 3.0.X) ([477eb5b](https://git.xfel.eu/Karabo/Framework/-/commit/477eb5be9e704d1740e670b62630c356ad06da74))

**************************
What's New in Karabo 3.0.3
**************************

Released on **September 1st, 2025**.

Bug Fixes
+++++++++

- *(GUI)* Fix image graph picker with downsampled image ([bdeb8ca](https://git.xfel.eu/Karabo/Framework/-/commit/bdeb8cac8d3ca19c87de3d4483bb0b03ac91fade))
- *(GUI)* Apply configuration only if the device is shown in editor. ([e3172be](https://git.xfel.eu/Karabo/Framework/-/commit/e3172be21e786a91623769591ef339fd0c23cab3))
- *(GUI)* Use AccessLevel also for ProjectDevices, no configuration... (Cherry-pick 3.0.X) ([e07290f](https://git.xfel.eu/Karabo/Framework/-/commit/e07290f9f41b3994602b3742b8dac81858196965))
- *(MDL)* Float dtype is float32, not anymore a float64 for the Float descriptor. ([1304ca8](https://git.xfel.eu/Karabo/Framework/-/commit/1304ca8cfda184135410a4862c8e8707d75baaef))

Features
++++++++

- *(GUI)* New indicator about guiextension updates ([c3bddcf](https://git.xfel.eu/Karabo/Framework/-/commit/c3bddcf79ef928e7cf961d62c00710f533a28f65))
- *(GUI)* OK-Errol-Bool show the keys and value in the tooltip. ([7af0cfb](https://git.xfel.eu/Karabo/Framework/-/commit/7af0cfb0b79d8c0e3ebfe66c509fa9afcd297e7a))
- *(GUI)* Init Configuration Preview dialog. (Cherry-pick hotfix 3.0.X) ([745aada](https://git.xfel.eu/Karabo/Framework/-/commit/745aadac27845f4a76f6b7369911b08e2059096d))
- *(GUI)* Add ProxyStatus to karabogui namespace (Cherry-pick 3.0.X) ([67bbbff](https://git.xfel.eu/Karabo/Framework/-/commit/67bbbffa7329fbb792ae148b14c4cc5bf0a4ee02))

**************************
What's New in Karabo 3.0.2
**************************

Released on **August 20th, 2025**.

Bug Fixes
+++++++++

- *(Bound)* Reduce timeout to get logs of devices ([103aa0a](https://git.xfel.eu/Karabo/Framework/-/commit/103aa0a01fbe39e2b87b636103dd881563983076))
- *(Bound)* Release GIL before emit(..) and call(..) ([831adcc](https://git.xfel.eu/Karabo/Framework/-/commit/831adcc21d04e384154f7f7e6ad7218f664dc594))
- *(GUI)* Update guiextension dialog- reinstall the packages ([6d33b11](https://git.xfel.eu/Karabo/Framework/-/commit/6d33b115d111d8478202697643b5deea12e06b23))
- *(GUI)* LoogBook : Set correct setDevicePixelRatio. ([5d762b1](https://git.xfel.eu/Karabo/Framework/-/commit/5d762b1dcbcda42f983accd2a743dd911aebecd1))
- *(GUI)* Verbose when install/uninstall of guiextensions fails ([965cf34](https://git.xfel.eu/Karabo/Framework/-/commit/965cf34667f4f49e9aae554c532642959fbe9056))
- *(MDL)* Consider Enums before Strings in wrapping karaboValues ([a337602](https://git.xfel.eu/Karabo/Framework/-/commit/a337602f37838b82588b32ae0799b3a140e6ab1a))
- *(MDL)* Fix initial topology gathering wait ([808681a](https://git.xfel.eu/Karabo/Framework/-/commit/808681a3a1b357b6fe2d1f45b5d7e1e1a7d73c7b))

Refactor
++++++++

- *(MDL)* Detach connector lock from eventloop on loop closure ([c48b40c](https://git.xfel.eu/Karabo/Framework/-/commit/c48b40ce1d68c5ead196e07cfc7e359f46f89460))
- *(No Category)* Move pytest asyncio config into toml file ([79c3eb7](https://git.xfel.eu/Karabo/Framework/-/commit/79c3eb7c2f68e823c8084d13bd45fc6447c98922))

**************************
What's New in Karabo 3.0.1
**************************

Released on **August 7th, 2025**.

Only adjustments to documentation and changes needed to publish to PyPi.

- *Deps* Up date CMake to a version that has an aarch64 installable([9704f747b](https://git.xfel.eu/Karabo/Framework/-/commit/9704f747b5ec477ab5f92a9dc8245ed13eb675ae))
- *CI* Adjust CI setting for moving from master to main([0d59515b7](https://git.xfel.eu/Karabo/Framework/-/commit/0d59515b7341ec8171c91d663874475d484e5f87))
- *fix(doc)* Update docs about supported operating systems([3da827f64](https://git.xfel.eu/Karabo/Framework/-/commit/3da827f6438e9647cde2b1f895a846bc0758de7f))
...
- Session Management for Authentication:
  ...
  - UserSessionDialog in the GUI shows now the time remaining for current session
  - Client Sessions are automatically logged out after 14 days if they don't reauthenticate
...
- Middlelayer functions `maximum` and `minimum` have been removed
...
- Element and Enum Removals or Changes:
  ...
  - Removed Element `Choice Of Node`
  - Removed Element `List Of Node`
  ...
  - Renamed `GenericElement` to `BaseElement` in C++
  - DeviceNode in MDL uses `classId` now instead of `displayType`
...
- Schema Elements in **Table Elements** with AccessMode `INITONLY` are currently rewritten as `RECONFIGURABLE`. This gives a warning. In future this will throw. Note that bound api
  default is `INITONLY`.
- Libraries not used by the Karabo Framework will be in future removed: matplotlib
...
- `pytest_asyncio` has been updated to 1.0.0. For a period until Winter 2026, device repositories making use of the central CI
  can specify USE_LEGACY_PYTEST = "true" to use old behavior (pytest 0.21.X).
  After that period, the central CI will change its default to make use of the new `pytest_asyncio`.
...
- *(GUI)* Update the url of guiextensions package([a736193c8](https://git.xfel.eu/Karabo/Framework/-/commit/a736193c85468a04db9f66dbf2fd27583b86c996))
- *CI* Also publish GUI beta releases like releases([ae1a1c8e0](https://git.xfel.eu/Karabo/Framework/-/commit/ae1a1c8e0f35e8027552e354c5998784b25faa01))
- *(C++ test)* Prepare for new broker settings concerning max message size([63993c56b](https://git.xfel.eu/Karabo/Framework/-/commit/63993c56b9df5064f447dda4ce05030f458ff7c8))
- *(C++ amqp)* Tuning connection destruction and logging([5f2c56f79](https://git.xfel.eu/Karabo/Framework/-/commit/5f2c56f79bf113f0e29a799384f7393d515a1440))
- *(GUI)* Disable scene loading for Operator([f6bb0a600](https://git.xfel.eu/Karabo/Framework/-/commit/f6bb0a600a72e1cfb7a402fc942eec09a1eae6af))
- *(MDL)* Output channel port is expert level([292ba1bb6](https://git.xfel.eu/Karabo/Framework/-/commit/292ba1bb630d21f826d17f474d6b8184b41addaa))
- *(GUI)* Fix the visibility of UserSession button in the application mode([ad7ba4372](https://git.xfel.eu/Karabo/Framework/-/commit/ad7ba4372943b1bada9ea2c4eae9a51e7ce2b577))
- *(C++)* Min and max size are expected to be unsigned int - not templated type([ee8dc8d84](https://git.xfel.eu/Karabo/Framework/-/commit/ee8dc8d848e5dc9d581c1fb0acd6f76b1d4a2306]))
- *(C++)* Do not send broadcasts a 2nd time as normal slot to instance '*' ([1f1011e](https://git.xfel.eu/Karabo/Framework/-/commit/1f1011eaf4b3ae1d0d2f9477981d6d10121dc767))
- *(C++)* Adjust broker rates to new AMQP mechanics ([839734d](https://git.xfel.eu/Karabo/Framework/-/commit/839734dd5563397fcf07e0d72b950f4e3fb2d1aa))
- *(C++ test)* Previuos fix for "preDestruction" failures missed an essential part ([177b5bb](https://git.xfel.eu/Karabo/Framework/-/commit/177b5bbdf7cce3c82dee699ff6e7a94b85d953e5))
- *(C++ test)* Another try for preDestruction test ([d3c445d](https://git.xfel.eu/Karabo/Framework/-/commit/d3c445db3d9359c4cfc6f66e748f29783b65fb27))
- *(GUI)* Hide User Session button for Observer ([59f753f](https://git.xfel.eu/Karabo/Framework/-/commit/59f753ff4013703189dee7b6598c5b8d48d58234))
- *(GUI)* Fix load scene from file after lazy load ([4ce4ae4](https://git.xfel.eu/Karabo/Framework/-/commit/4ce4ae4cf9c00ae014f882dff2cbbf2795476deb))
- *(GUI)* Typo in the ui file name and docstring ([073f994](https://git.xfel.eu/Karabo/Framework/-/commit/073f994c696c0e9f63814675809a37dae7840ddd))
- *(GUI)* Scene editing from project panels needs different access role ([595a2d5](https://git.xfel.eu/Karabo/Framework/-/commit/595a2d579e4e25c71e4617251c326e0d6b573d50))
- *(GuiServer)* Fix audit tracking for core services and increase minimum client version ([a75a529](https://git.xfel.eu/Karabo/Framework/-/commit/a75a52980217a7406d357682c0479f24ee46aae5))
- *(ProjectDB)* Configure timeout for local project db ([ddef9d3](https://git.xfel.eu/Karabo/Framework/-/commit/ddef9d371fe5538b005b56e7920a04b39e63d8c3))
- *(ProjectDB)* Fix scene retrieval for slotGetScene after protocol change ([bdb35a1](https://git.xfel.eu/Karabo/Framework/-/commit/bdb35a156c93661286cdbbe9752478eb9fb08406))
- *(test)* Make the config manager test more robust in integration testing ([0358786](https://git.xfel.eu/Karabo/Framework/-/commit/035878678309ec8b334ed0787b9aecfc59abd749))
- *(C++)* Directly include what is used ([1042088](https://git.xfel.eu/Karabo/Framework/-/commit/10420880cda76ae7be7c91e859248fd01e425b40))
- *(C++ test)* Check for preDestruction been called was pretty flaky ([7a610b7](https://git.xfel.eu/Karabo/Framework/-/commit/7a610b7034451405806bb6cd2545947111751301))
- *(ConfigDB)* Make sure to have a single commit for transaction, use multiple threads ([e248c98](https://git.xfel.eu/Karabo/Framework/-/commit/e248c9887916fc9e42c3816045daf93b12eaa41d))
- *(ConfigDB)* Fix concurrent locking issues ([772c5c4](https://git.xfel.eu/Karabo/Framework/-/commit/772c5c42be6ae3334d80ba8c69be079ec82d8a46))
- *(GUI)* Align html parsing and remove deprecation warning in wizard ([8d945f7](https://git.xfel.eu/Karabo/Framework/-/commit/8d945f7d6aa4f28a5e58ce3b06002b9b65ee8815))
- *(GUI)* Don't overwrite QSettings in gui tests and remove dbtoken from config singleton ([9c60ef8](https://git.xfel.eu/Karabo/Framework/-/commit/9c60ef885d65e5db18182080eac2dd43bd7f92f5))
- *(GUI)* UserSessionDialog - method to clear the refresh token. ([68b8999](https://git.xfel.eu/Karabo/Framework/-/commit/68b899928cc4c6af782b45c2424b8071bc5b536e))
- *(GUI)* Init Config- confirmation dialog before removing/overwriting config ([53d7696](https://git.xfel.eu/Karabo/Framework/-/commit/53d7696c0dbdd041f69025bc292cd44ed82dfbc5))
- *(karabo script)* Take care of package prefix for develop (i.e. if not default karaboDevices3) ([0ac1c36](https://git.xfel.eu/Karabo/Framework/-/commit/0ac1c36a93fcc92b23e6b9e9d35d4c5a505b402f))
- *(Bound)* Fix propertytest image type definition ([ac67d2c](https://git.xfel.eu/Karabo/Framework/-/commit/ac67d2ce0ca74d50ff3ce659dcc46c71155fa4b5))
- *(Bound)* Fix cross test bound device with schema type definition for image data ([5320fd8](https://git.xfel.eu/Karabo/Framework/-/commit/5320fd8fa13cc116198f6a4df2d947ff69edff7b))
- *(Bound/C++)* Fix setAlarmCondition, don't consider info and acknowledgement ([3255d29](https://git.xfel.eu/Karabo/Framework/-/commit/3255d2924e1b7ba46be8d0a5e91ab69bdd9866c5))
- *(C++)* Properly delete unique_ptr to array ([1323ce5](https://git.xfel.eu/Karabo/Framework/-/commit/1323ce52f43f7c4d9e645d0ddf714b4802e625c7))
- *(C++)* Stop event loop even if stopped before running ([c79463e](https://git.xfel.eu/Karabo/Framework/-/commit/c79463e427458304cdabd91cdfa083906c08ca82))
- *(GUI)* Fix copy & paste models after lazy reading of scenes ([fff3bf6](https://git.xfel.eu/Karabo/Framework/-/commit/fff3bf6d26dc5a2cc555b1d0513d4127f6d58332))
- *(GUI)* Fix the scene controller editing when having a lazy scene ([a91fc16](https://git.xfel.eu/Karabo/Framework/-/commit/a91fc163be97337cfd9666634fb53722037343b7))
- *(GUI)* Assure model data before saving to file ([bbcebeb](https://git.xfel.eu/Karabo/Framework/-/commit/bbcebebd4799ad1e91a24a944c33a33648df7563))
- *(GUI)* Fix lazy scene replace from file ([b2f2da0](https://git.xfel.eu/Karabo/Framework/-/commit/b2f2da0a83ed91a917c60082980ab29f954aab47))
- *(GUI)* Prevent event on text log widget when there is no binding ([a3d4079](https://git.xfel.eu/Karabo/Framework/-/commit/a3d40790c306592536784a3fcec82203ceac86fc))
- *(ProjectDB)* Remove tuple error in declaration ([5609d0b](https://git.xfel.eu/Karabo/Framework/-/commit/5609d0bbb959dfe5b7327cb02c2b3ebca00feeac))
- *(karabind)* Do not offer kwargs for allowedStates since not used ([aff492a](https://git.xfel.eu/Karabo/Framework/-/commit/aff492a24d8c958e17c6013a59edf141a8200629))
- *(No Category)* Remove device egg remnant from integration tests ([cc4d1dc](https://git.xfel.eu/Karabo/Framework/-/commit/cc4d1dca0986de3df946b85a674c08fb1d7e3496))
...
- *(C++)* Add Dims::operator<<([01522887b](https://git.xfel.eu/Karabo/Framework/-/commit/01522887beec480be71ccdcbb88a372ac0d73e40))
- *(C++)* Add an injected property to PropertyTest ([add1fb4](https://git.xfel.eu/Karabo/Framework/-/commit/add1fb4f2a28d9b41a97353ee60ed8ea9d13ed76))
- *(GUI)* Add function to get the status icon to namespce. ([923db26](https://git.xfel.eu/Karabo/Framework/-/commit/923db26228d11f61166955fc93bf7849570a21c9))
- *(GUI)* New Event when an item in SystemTopology updates. ([be619fd](https://git.xfel.eu/Karabo/Framework/-/commit/be619fd573b5789a73ac920453592a53a38d210c))
- *(No Category)* Increase release candidate for the guiserver minimum client version ([148c065](https://git.xfel.eu/Karabo/Framework/-/commit/148c06520335f151112592a787b3ee7bd7d7bce2))
- *(GUI)* Provide session information on dialog open ([4ff5134](https://git.xfel.eu/Karabo/Framework/-/commit/4ff51342795ce5f153ed5fd482fe647a5deecb79))
- *(GuiServer)* Add python integration tests, proof of principle ([cfaae91](https://git.xfel.eu/Karabo/Framework/-/commit/cfaae91388a63bf718adcab7e0ae0f2d3b3e24d7))
- *(Tests)* Make config db manager cross test ci concurrency adaptable ([3ad263c](https://git.xfel.eu/Karabo/Framework/-/commit/3ad263ce341be34b4ee872a38922f6e94d65cc59))
- *(Tests)* Migrate all guiserver non auth tests to python integration tests ([e624b36](https://git.xfel.eu/Karabo/Framework/-/commit/e624b364e706371e91efebad065a509802541f60))
- *(No Category)* Provide hint when uninstalling ([99f41f6](https://git.xfel.eu/Karabo/Framework/-/commit/99f41f62f7c17334d3ef62083b59c67ded27d9fa))
- *(Bound)* Generalize Runner, help few keys ([41a00ba](https://git.xfel.eu/Karabo/Framework/-/commit/41a00ba9ff692e1478187e0d7f6fafae915e945d))
- *(Bound)* AsyncConnect for timeserver, a thread less ([d1bbd9c](https://git.xfel.eu/Karabo/Framework/-/commit/d1bbd9cbea1b6fd7a0d09f5d1889866cdceffd86))
- *(Bound)* Provide Hash.update functionality ([8a2b14d](https://git.xfel.eu/Karabo/Framework/-/commit/8a2b14d80399638a30d2d676e36fa271f616d898))
- *(Bound)* PythonDevice.set with kwargs, but w/o validate flag ([2193279](https://git.xfel.eu/Karabo/Framework/-/commit/2193279a15ec2bf870162d16b36c4a2545ccb790))
- *(Bound)* Graceful device.get ([d4911c5](https://git.xfel.eu/Karabo/Framework/-/commit/d4911c5e6ac3a09cb0f8026cccda6c2e476b4c80))
- *(C++)* Strict validator requires NDArray type and schema to be defined ([e0706c4](https://git.xfel.eu/Karabo/Framework/-/commit/e0706c480e6ab4362e60bb2275968f9ebc4eb6e1))
- *(C++)* Do not throttle "status" property on its way from GUI server to client ([aefc51a](https://git.xfel.eu/Karabo/Framework/-/commit/aefc51a7fbe02b1ebf31c647fd8537790869439e))
- *(C++)* Add timing output to pipeline tests, also use safeNDArray=true where it can help ([7c7b449](https://git.xfel.eu/Karabo/Framework/-/commit/7c7b449b85d09f4c4b5b4872185d02b49b24992b))
- *(C++/Bound)* Always validate output channel schema ([563baa3](https://git.xfel.eu/Karabo/Framework/-/commit/563baa3dd3d17bf407c5c4bdbb6f1db03303fb78))
- *(GUI)* Provide device topology for a the selected domain ([49a5212](https://git.xfel.eu/Karabo/Framework/-/commit/49a52124017948a871455ecca660a4715ea9f3cd))
- *(GUI)* Implement TrendOptions for the trendline widgets ([a4a727e](https://git.xfel.eu/Karabo/Framework/-/commit/a4a727e228aa6dff758cd82dd4f77a32d7e95b8c))
- *(GUI)* Show conflicts in classId and serverId and provide a log widget for the pdb ([96d5dc4](https://git.xfel.eu/Karabo/Framework/-/commit/96d5dc46ceb55e2a97fcb98cc01da89fc1bb03ff))
- *(GUI)* Extend karabogui.api namespace ([2c77a4c](https://git.xfel.eu/Karabo/Framework/-/commit/2c77a4c475d65be9e328091b411285a45c794865))
- *(MDL)* Include DeviceClasses in server log on instantiation ([26377d1](https://git.xfel.eu/Karabo/Framework/-/commit/26377d1ac4f8ae561382476b89052b5b91b824a0))
- *(ProjectDB)* Instantiate ProjectDevice funtionality ([a23e595](https://git.xfel.eu/Karabo/Framework/-/commit/a23e5955ad81db5842f84068a64fa13567c3aa66))
- *(doc)* Provide merge log until 3.0.0rc3 ([0c51305](https://git.xfel.eu/Karabo/Framework/-/commit/0c51305041f045b20588e1a4cba50d4a8c501c87))
- *(No Category)* Provide legacy pytest flag in mdl template ([33e52fe](https://git.xfel.eu/Karabo/Framework/-/commit/33e52fe80e021f8a55523588e5f97d3b557805c4))
...
- *(C++)* Avoid to copy every message header ([aeb564d](https://git.xfel.eu/Karabo/Framework/-/commit/aeb564d797cc6e306e555db617ed77b2b4d8799e))
...
- *(C++)* Rename GenericElement to BaseElement ([84f0866](https://git.xfel.eu/Karabo/Framework/-/commit/84f0866559d70e16cfba1bbb6e519a5769cd491a))
- *(ConfigDB)* Sync timestamp, rename timepoint ([9e0c2d8](https://git.xfel.eu/Karabo/Framework/-/commit/9e0c2d8e1fb3c59aece18f8daa589e4c75f46810))
- *(ConfigDB)* Migrate timestamp to date globally ([e52d2c6](https://git.xfel.eu/Karabo/Framework/-/commit/e52d2c6345eceb273a10bccffc62511cff84f482))
- *(GUI)* InitConfig Preview Dialog now has OK button ([7cbc7cd](https://git.xfel.eu/Karabo/Framework/-/commit/7cbc7cd329091de5676364a0ede090fb7be761cd))
- *(GUI)* Remove signal from options dialog, avoid references and only change model on changes ([2535f48](https://git.xfel.eu/Karabo/Framework/-/commit/2535f48fe209fa30dab66eda58126a91499c3eb9))
- *(GUI)* Also provide same action text for runtime configuration in configurator panel ([46aa341](https://git.xfel.eu/Karabo/Framework/-/commit/46aa341487651f30c5645a0cc7b3783cb51899f9))
- *(GUI)* Move assure svg data in scene file load ([a0f6a51](https://git.xfel.eu/Karabo/Framework/-/commit/a0f6a51e0069d7073eb1925496dd6a4f20ecce3f))
- *(GuiServer)* Rename brokerInformation to serverInformation ([7ed4dbd](https://git.xfel.eu/Karabo/Framework/-/commit/7ed4dbd3b1519873c47f2f2854ff86b4cffefca4))
- *(MDL)* Offer DeviceServer in namespace ([a857ccc](https://git.xfel.eu/Karabo/Framework/-/commit/a857ccc5eb87eb4505ac79ad4526d6a57981734d))
- *(MDL)* Fix classId attribute on strings and change deviceNode classId ([1dfd315](https://git.xfel.eu/Karabo/Framework/-/commit/1dfd315e865705daee0c7948bdb33f094aff7f53))
- *(MDL)* Use the async context for locking in connector ([ef4d643](https://git.xfel.eu/Karabo/Framework/-/commit/ef4d643857245c53f323c0478dfd4aca95870377))
- *(ProjectDB)* Throw if item loading failed. load item always needs item_type ([fe00f20](https://git.xfel.eu/Karabo/Framework/-/commit/fe00f20d28be07df551be67a899341b347d1b671))
- *(Test)* Move gui server scene test to python integrationtests ([e27e500](https://git.xfel.eu/Karabo/Framework/-/commit/e27e5006c61eefa028459566d20563ddba9cb07a))
- *(test)* Harden integration tests for guiserver and move test ini ([1699248](https://git.xfel.eu/Karabo/Framework/-/commit/1699248c45c4c9109eeb4b6828b6991a8b697269))
- *(C++)* Revert "Replace boost::regex by std::regex" ([2311e24](https://git.xfel.eu/Karabo/Framework/-/commit/2311e24fbf3991c2f16aacacb2b7556e8fa6d3f9))
- *(C++ test)* Revert pipe test timing to before switch to std::regex ([8e1ed32](https://git.xfel.eu/Karabo/Framework/-/commit/8e1ed32753a4b1c10a84d2d33882f39ef4a4260d))
- *(ConfigDB)* Make migration script independent of the order, put more utility and argparse ([edbf896](https://git.xfel.eu/Karabo/Framework/-/commit/edbf8969f81da4b42cd6fa04d5cca01be353eac7))
- *(DEPS)* Remove peewee from the dependencies ([e979737](https://git.xfel.eu/Karabo/Framework/-/commit/e979737173bcffb71b6a0417144305f8446da19b))
- *(FW)* AutoDelete Exchange and use different Exchanges: Slots, Signals, Global_Slots ([d06af1c](https://git.xfel.eu/Karabo/Framework/-/commit/d06af1c7ef21171652214bb3c36eb7d0cce9e53e))
- *(GUI)* User Session Info instead of temporary session ([b208076](https://git.xfel.eu/Karabo/Framework/-/commit/b208076b52aa4cda6946d3439adcce1debcd7278))
- *(GUI)* Rename action items for configuration from time and init and add an icon ([d15a835](https://git.xfel.eu/Karabo/Framework/-/commit/d15a8353c27e111552656f329618b8b82ead172d))
- *(GuiServer)* Change on type return for session info ([04c2274](https://git.xfel.eu/Karabo/Framework/-/commit/04c227407b10ff706476addcf1eabe3252bc326f))
- *(GuiServer)* Change type declaration ([4b1737c](https://git.xfel.eu/Karabo/Framework/-/commit/4b1737c5584f0b1c26581e3bd1c475075477e8db))
- *(MDL)* Remove minimum and maximum functions ([212598f](https://git.xfel.eu/Karabo/Framework/-/commit/212598fea79eee75a88fa2b4e08fb57dbf5635f0))
- *(ProjectDB)* Only wrap date format in wrap xml ([b90994b](https://git.xfel.eu/Karabo/Framework/-/commit/b90994b7f54e17c215e622ab874ceeba61953cf1))
- *(ProjectDB)* Use flush for atomic operations in project db: ([920197b](https://git.xfel.eu/Karabo/Framework/-/commit/920197b1dc748bbcbfbc69a675878b52e0e576a1))
- *(test)* Add auth guiserver tests to python integration tests ([c37f489](https://git.xfel.eu/Karabo/Framework/-/commit/c37f4896313b1cf5817627963047f0490fa0ff3f))
- *(test)* Remove first batch of C++ guiserver integration tests ([6bebe47](https://git.xfel.eu/Karabo/Framework/-/commit/6bebe47528ba87cbbeee6c46c72f8a0ab2d10206))
- *(Bound)* Hash constructor allows  arbitrary number of key/value pairs. Dictionary allowed as well. ([f954a9b](https://git.xfel.eu/Karabo/Framework/-/commit/f954a9bff627b9c7a9356cb66f0fb8d3c3d3b00e))
- *(Bound, C++)* Remove _serverId_ property ([7d8898d](https://git.xfel.eu/Karabo/Framework/-/commit/7d8898de39abcbf0aed02d59d6c0a347ba895f3e))
- *(Bound/C++)* Make deviceId and serverId formally init only parameters ([0abf9e6](https://git.xfel.eu/Karabo/Framework/-/commit/0abf9e61dcd77d69d79ad1b089665dd39f56a1d3))
- *(C++)* Simplify runner interface ([f626581](https://git.xfel.eu/Karabo/Framework/-/commit/f62658106c77960dd29c11e4b34a7373628323eb))
- *(C++)* Remove absolute and relative Error definitions ([9777bb8](https://git.xfel.eu/Karabo/Framework/-/commit/9777bb82dec42cea4a1b6c86e19e9f1a5fdbb6ba))
- *(C++)* Remove setTopic(..) as never usable outside SignalSlotable ([ab032bc](https://git.xfel.eu/Karabo/Framework/-/commit/ab032bc4926b9d7e1fd1d30f3149d285ddbdeee7))
- *(C++)* Make header match its class: AlarmCondition w/o trailing 's' ([89f3f4e](https://git.xfel.eu/Karabo/Framework/-/commit/89f3f4e05ad168d3b52097cdce15438196274462))
- *(C++ test template)* No need of redundant deviceId specification ([e3000ae](https://git.xfel.eu/Karabo/Framework/-/commit/e3000ae5366875175e60d3b22ed7a333c74619c7))
- *(C++, Bound)* Remove _deviceId_ property ([3fc9961](https://git.xfel.eu/Karabo/Framework/-/commit/3fc99610d93a76ce2f4641ce1891f0a3bef21068))
- *(C++/Bound)* Remove raw pointers 'PTR_xxx' and 'ANY' from ReferenceTypes ([e67a976](https://git.xfel.eu/Karabo/Framework/-/commit/e67a9768b7f1a600cee55ef3154ce7cc7351fc9e))
- *(C++/Bound)* Be strict about property keys ([89f11eb](https://git.xfel.eu/Karabo/Framework/-/commit/89f11eb291cdb7d32fc86c7fbb3923b2fc09ba77))
- *(C++/Bound)* Remove unused dataSchema(..) of INPUT_CHANNEL ([e532828](https://git.xfel.eu/Karabo/Framework/-/commit/e532828639870adc44754387f5bf3d3212f84981))
- *(C++/Bound)* Align a few log leftovers ([fca7c24](https://git.xfel.eu/Karabo/Framework/-/commit/fca7c2465c6df096078017c3d11d9ee53c0c829b))
- *(ConfigDB)* Unify timestamp handling with projectDB ([51cc307](https://git.xfel.eu/Karabo/Framework/-/commit/51cc3074b6f854ebefc16b6c7091f3aff017e831))
- *(FW)* Less heartbeats, but similar discovery of crash of normal objects ([33d2b3d](https://git.xfel.eu/Karabo/Framework/-/commit/33d2b3da7f8cba3bcddb27d8ff639a21b73cbd29))
- *(FW)* Get rid of pipelining 'queue' option (since same as 'queueDrop') ([c83825a](https://git.xfel.eu/Karabo/Framework/-/commit/c83825ac245cfd0e62fd97db19029a36349b7746))
- *(GUI)* Refactor project device status paint and fix the change of classId ([184c5e9](https://git.xfel.eu/Karabo/Framework/-/commit/184c5e9bf162751b57c360278894af889147a454))
- *(GUI)* Cleanup change of project device state ([f379745](https://git.xfel.eu/Karabo/Framework/-/commit/f37974518a31937e3f18a3c6b5175a4a6bddcaee))
- *(GUI)* Remove not required alarms in dict ([4da15da](https://git.xfel.eu/Karabo/Framework/-/commit/4da15dab2833fa214b82cf05162cd5709537350c))
- *(GUI)* Remove CheckState role from project model ([19b4121](https://git.xfel.eu/Karabo/Framework/-/commit/19b41213bbfc0c1b9beb8a87bb424032135398c7))
- *(GUI)* Remove unused manager handles ([481dad7](https://git.xfel.eu/Karabo/Framework/-/commit/481dad769a2ba37ccaa3c7ce7237e272b3c0bcef))
- *(GUI)* Align size and look of curve options dialog ([2b14e61](https://git.xfel.eu/Karabo/Framework/-/commit/2b14e61a17e9c1697d7f0948c1f380d30f5b5413))
- *(GUI)* Align float formatting in the GUI ([a1e22b5](https://git.xfel.eu/Karabo/Framework/-/commit/a1e22b5fb1c5cdf102709733d255307d1f20b64a))
- *(GUI)* Set the application icon on the mainwindow as well ([eb04506](https://git.xfel.eu/Karabo/Framework/-/commit/eb0450662af4dd0582a54012040a43402eaa92db))
- *(GUI)* Cleanup configuration util functions ([bd9e751](https://git.xfel.eu/Karabo/Framework/-/commit/bd9e7513f5b8fd95427a97d84544766162561ba8))
- *(GUI)* Remove not required messagebox warning for domains ([efa2f4f](https://git.xfel.eu/Karabo/Framework/-/commit/efa2f4f9398142be770b28c69ba91413d9b50957))
- *(GUI)* Remove half_samples from graph plots ([17bcc49](https://git.xfel.eu/Karabo/Framework/-/commit/17bcc49905fb91b3654cc2b3bb2984d6d52cdbfb))
- *(GUI)* A little event cleanup ([e13e75c](https://git.xfel.eu/Karabo/Framework/-/commit/e13e75cd286182875904886155f9a7476ce36ec4))
- *(GUI)* Karabo GUI Icon for Karabo 3 ([84d72b7](https://git.xfel.eu/Karabo/Framework/-/commit/84d72b77916e4c4cabf83de1651c35c5a3053c6a))
- *(GUI)* Change the scene icon for unattached scenes ([661f263](https://git.xfel.eu/Karabo/Framework/-/commit/661f263447c79530545b5465d511e21578359b38))
- *(GUI)* Remove the  wording from the unattached message ([c475359](https://git.xfel.eu/Karabo/Framework/-/commit/c4753595bd590c19725906d04a65a548b7a046a3))
- *(MDL)* Remove _serverId_ from the device ([6a6200e](https://git.xfel.eu/Karabo/Framework/-/commit/6a6200e1d90e3075629d48064bd703c7604bd400))
- *(MDL)* Native shape is a tuple in ImageData ([9a0686d](https://git.xfel.eu/Karabo/Framework/-/commit/9a0686d62601a5b4bb06302a956fddd99aaea7cb))
- *(MDL)* Align the error messages when instantiating ([386dd8f](https://git.xfel.eu/Karabo/Framework/-/commit/386dd8f2a5adf7628fcb92025c39bd5fbfe16914))
- *(MDL)* Remove _deviceId_ from instances ([c42ba83](https://git.xfel.eu/Karabo/Framework/-/commit/c42ba834475b69c3543dcfd9101c268564d04b3f))
- *(MDL)* Set the loop scopes properly via the ini file and not via conftest ([3095700](https://git.xfel.eu/Karabo/Framework/-/commit/3095700cc30b30469e24cbdf54ed802dcb85893b))
- *(MDL)* Use warn with stackLevel instead of warnexplicit ([d0a0082](https://git.xfel.eu/Karabo/Framework/-/commit/d0a00824a670f82b838436f9e29acd1bcc74cb61))
- *(MDL)* Deprecate absoluteError and relativeError ([40e70be](https://git.xfel.eu/Karabo/Framework/-/commit/40e70becdc4d8a8ed33d8a3eda5f57311631f8af))
- *(ProjectDB)* Provide more information on project device database ([18bfc49](https://git.xfel.eu/Karabo/Framework/-/commit/18bfc49b73ffc69549a3e9b024403e35c09c368a))
- *(ProjectDB)* More readablity attempt ([a8d188d](https://git.xfel.eu/Karabo/Framework/-/commit/a8d188de0bad96a6c6327c906f43c1f3ec422b54))
- *(ProjectDB)* Cleanup uuid usage ([2038496](https://git.xfel.eu/Karabo/Framework/-/commit/20384968f980d11d02dd5954b781d2073fa71d01))
- *(ProjectDB)* Cleanup project database saving return ([ac95160](https://git.xfel.eu/Karabo/Framework/-/commit/ac95160d1c2ced5f07ac63bce20f886f0e725019))
- *(ProjectDB)* Clean up service.in and make existdb the default ([1f38b21](https://git.xfel.eu/Karabo/Framework/-/commit/1f38b2138250c24e3f354263904c66f06a815dcd))
- *(No Category)* Remove train master and pulse master daqDataTYpe ([395898c](https://git.xfel.eu/Karabo/Framework/-/commit/395898cb511e94ab51a2eeb218b238ad921a16d2))
- *(No Category)* Use StrEnum for States and Alarms ([bf51315](https://git.xfel.eu/Karabo/Framework/-/commit/bf51315fdf4f3d1b4732bc4f204f168f7e0f5730))
- *(No Category)* Less trainId, use timeId for TimeMixin etc ([bee4d4d](https://git.xfel.eu/Karabo/Framework/-/commit/bee4d4d845e117fcde434e27af1c4a608749f2ea))
...
- *(CI)* Only proper releasese for the GUI...([b1977e5de](https://git.xfel.eu/Karabo/Framework/-/commit/b1977e5de75da069a8e8e1fcd905dfad6cffd3db))
- *(CI)* Temporarily publish release candidates of GUI([417f37380](https://git.xfel.eu/Karabo/Framework/-/commit/417f37380b2de9eaece76225cdfd11614722743c))
- *(CI)* Also publish GUI beta releases like releases([ae1a1c8e0(https://git.xfel.eu/Karabo/Framework/-/commit/ae1a1c8e0f35e8027552e354c5998784b25faa01())
...
- *(doc)* Update new changelog for Karabo 3 ([2acc4f1ec]https://git.xfel.eu/Karabo/Framework/-/commit/2acc4f1ec5da1f247e92a405fab28a08084f644a))
- *(No Category)* Update Changelog to 3.0.0rc11 ([4e24dc8](https://git.xfel.eu/Karabo/Framework/-/commit/4e24dc8df464a21d3f610071248bcee8d13ade5e))
- *(No Category)* Document the create hierarchy in project test ([3e640f9](https://git.xfel.eu/Karabo/Framework/-/commit/3e640f91544fc3587aa12e2c73953b27c793dd44))
- *(No Category)* A bit fine tuning the docs and add a few ([2c23a5f](https://git.xfel.eu/Karabo/Framework/-/commit/2c23a5f1a023f55267688fb1583cc58430c03d72))
- *(No Category)* Add merge log until rc8 ([3d508ca](https://git.xfel.eu/Karabo/Framework/-/commit/3d508caf1c22f95470d0519e4b63974b5de42d26))
- *(No Category)* Document more the changes ([b9d50fe](https://git.xfel.eu/Karabo/Framework/-/commit/b9d50fe9accfaeac37006b69f7fe0fda560ed29e))
- *(No Category)* Tune more the doc data types for MDL ([94aaf8c](https://git.xfel.eu/Karabo/Framework/-/commit/94aaf8cc6b2b43212301b9db35113f1b24532cb0))
- *(No Category)* Document more the 3.X release with breaking changes etc. ([339407a](https://git.xfel.eu/Karabo/Framework/-/commit/339407aa231d4207f8e2ea0147b7f01e0e77719a))
- *(No Category)* Try different formatting for rc3 ([63f17f9](https://git.xfel.eu/Karabo/Framework/-/commit/63f17f971d6152b65be2916b0225fc89f8206021))
- *(No Category)* Add more information on rc3 ([29fac5a](https://git.xfel.eu/Karabo/Framework/-/commit/29fac5a085ffe229f39088eee57f7e52c5f71e25))
- *(No Category)* Add more breaking changes and sort a bit ([2a6ae56](https://git.xfel.eu/Karabo/Framework/-/commit/2a6ae5660852425f0bcffcb2da18afd33bf7e546))
- *(No Category)* Align someformatting for Karabo 3 WhatsNew ([2eae75f](https://git.xfel.eu/Karabo/Framework/-/commit/2eae75f505ea068c17cd6d0ba929930e53067b4d))
- *(No Category)* Fix a few formatting issues and typoes ([67af528](https://git.xfel.eu/Karabo/Framework/-/commit/67af5280ea376d276f045ea85d00922d63df213e))
