...
This patch release fixes a datalogger connection issue found in a lab installation.
A few performance improvements for output channels in the C++ device.
The Middlelayer API has some bugfixes for tests and features of 2.16.0.
The GUI client has some validation and future proofing improvements.
