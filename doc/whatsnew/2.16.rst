...
- Upgrade of Python, Qt5 and pyQtGraph version got the GUI Client
...
- C++: More robust device monitoring in GuiServerDevice. !6591
...
- C++: Add integration tests for GUI Server one-time token validation. !6769
- C++: PropertyTest::slotUpdateSchema recreates its output channel. !6807
...
- C++: Fix class schema forward loophole in GuiServer. !6894
- C++: Protect against loosing device schema in GuiServer. !6908
- C++: Fix that empty slot name was ignored. !6911
...
- C++: Add integration tests for GUI Server one-time token validation. !6769
- C++: PropertyTest::slotUpdateSchema recreates its output channel. !6807
- Pipe integration test: relax requirement on data throughput. !6808
...
- C++: Protect against loosing device schema in GuiServer. !6908
- C++: Fix that empty slot name was ignored. !6911
- Framework: Better message when no schema is found during GetConfigurationFromPast. !6891
