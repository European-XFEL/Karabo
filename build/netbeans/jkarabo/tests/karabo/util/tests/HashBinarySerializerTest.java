...
import static karabo.util.Hash.similar;
import karabo.util.HashBinarySerializer;
 ...
 * @author esenov
 */
public class HashBinarySerializerTest {

    public HashBinarySerializerTest() {
    }
    ...
    public void testHashSimple() {
        ...
        hash.set("aNone", CppNone.getInstance());
//        System.out.println("Saved hash is ...\n" + hash);
//        VectorString vBaseClasses = Configurator.getRegisteredBaseClasses();
//        VectorString vBinarySerializer = Configurator.getRegisteredClasses(BinarySerializerHash.class);
//        
//        System.out.println("Base classes registry is ...");
//        for (String name : vBaseClasses) {
//            System.out.println("\tClass " + name);
//        }
//        System.out.println("Registry of base class BinarySerializerHash");
//        for (String name : vBinarySerializer) {
//            System.out.println("\tClass " + name);
//        }

        BinarySerializer<Hash> serializer = BinarySerializerHash.create(BinarySerializerHash.class, "Bin", new Hash());
        try {
...
//        System.out.println("Saved hash is ...\n" + hash);
        BinarySerializerHash serializer = BinarySerializerHash.create(BinarySerializerHash.class, "Bin", new Hash());
        try {
            ByteBuffer archive = serializer.save(hash);
            Hash hash2 = serializer.load(archive);
//            System.out.println("Loaded hash is ...\n" + hash2);
