...
${TESTDIR}/_ext/783893685/xmsLongTestRunner.o: ../../../src/cppLongTests/xms/xmsLongTestRunner.cc 
	${MKDIR} -p ${TESTDIR}/_ext/783893685
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -D__SO__ -I../../../src -I${KARABO}/extern/include -I. `pkg-config --cflags karaboDependencies-${CND_PLATFORM}` -std=c++11  -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/783893685/xmsLongTestRunner.o ../../../src/cppLongTests/xms/xmsLongTestRunner.cc
