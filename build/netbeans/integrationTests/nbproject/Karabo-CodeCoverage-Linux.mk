...
# CC Compiler Flags
CCFLAGS=-std=c++14 -Wfatal-errors -Wno-unused-local-typedefs -fprofile-arcs -ftest-coverage
CXXFLAGS=-std=c++14 -Wfatal-errors -Wno-unused-local-typedefs -fprofile-arcs -ftest-coverage
...
${TESTDIR}/TestFiles/f10: ${TESTDIR}/_ext/567603001/BaseLogging_Test.o ${TESTDIR}/_ext/567603001/DataLogging_Test.o ${TESTDIR}/_ext/567603001/integrationRunner_11.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
...
${TESTDIR}/_ext/567603001/BaseLogging_Test.o: ../../../src/integrationTests/BaseLogging_Test.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`  `pkg-config cppunit --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/BaseLogging_Test.o ../../../src/integrationTests/BaseLogging_Test.cc
...
${TESTDIR}/_ext/567603001/Device_Test.o: ../../../src/integrationTests/Device_Test.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I. `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/Device_Test.o ../../../src/integrationTests/Device_Test.cc


${TESTDIR}/_ext/567603001/integrationRunner_9.o: ../../../src/integrationTests/integrationRunner_9.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I. `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/integrationRunner_9.o ../../../src/integrationTests/integrationRunner_9.cc


${TESTDIR}/_ext/567603001/LockTestDevice.o: ../../../src/integrationTests/LockTestDevice.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`  `pkg-config cppunit --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/LockTestDevice.o ../../../src/integrationTests/LockTestDevice.cc


${TESTDIR}/_ext/567603001/LockTest_Test.o: ../../../src/integrationTests/LockTest_Test.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`  `pkg-config cppunit --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/LockTest_Test.o ../../../src/integrationTests/LockTest_Test.cc
...
${TESTDIR}/_ext/567603001/GuiServer_Test.o: ../../../src/integrationTests/GuiServer_Test.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I. `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/GuiServer_Test.o ../../../src/integrationTests/GuiServer_Test.cc


${TESTDIR}/_ext/567603001/TcpAdapter_5.o: ../../../src/integrationTests/TcpAdapter_5.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I. `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/TcpAdapter_5.o ../../../src/integrationTests/TcpAdapter_5.cc


${TESTDIR}/_ext/567603001/integrationRunner_10.o: ../../../src/integrationTests/integrationRunner_10.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I. `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/integrationRunner_10.o ../../../src/integrationTests/integrationRunner_10.cc
...
${TESTDIR}/_ext/567603001/TcpAdapter_3.o: ../../../src/integrationTests/TcpAdapter_3.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`  `pkg-config cppunit --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/TcpAdapter_3.o ../../../src/integrationTests/TcpAdapter_3.cc
...
${TESTDIR}/_ext/567603001/NonSceneProviderTestDevice.o: ../../../src/integrationTests/NonSceneProviderTestDevice.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I. `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/NonSceneProviderTestDevice.o ../../../src/integrationTests/NonSceneProviderTestDevice.cc


${TESTDIR}/_ext/567603001/SceneProviderTestDevice.o: ../../../src/integrationTests/SceneProviderTestDevice.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I. `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/SceneProviderTestDevice.o ../../../src/integrationTests/SceneProviderTestDevice.cc


${TESTDIR}/_ext/567603001/SceneProvider_Test.o: ../../../src/integrationTests/SceneProvider_Test.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I. `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/SceneProvider_Test.o ../../../src/integrationTests/SceneProvider_Test.cc


${TESTDIR}/_ext/567603001/TcpAdapter_4.o: ../../../src/integrationTests/TcpAdapter_4.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I. `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/TcpAdapter_4.o ../../../src/integrationTests/TcpAdapter_4.cc


${TESTDIR}/_ext/567603001/integrationRunner_7.o: ../../../src/integrationTests/integrationRunner_7.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I. `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/integrationRunner_7.o ../../../src/integrationTests/integrationRunner_7.cc


${TESTDIR}/_ext/567603001/SimulatedTimeServerDevice.o: ../../../src/integrationTests/SimulatedTimeServerDevice.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I. `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/SimulatedTimeServerDevice.o ../../../src/integrationTests/SimulatedTimeServerDevice.cc


${TESTDIR}/_ext/567603001/TimingTestDevice.o: ../../../src/integrationTests/TimingTestDevice.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I. `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/TimingTestDevice.o ../../../src/integrationTests/TimingTestDevice.cc


${TESTDIR}/_ext/567603001/Timing_Test.o: ../../../src/integrationTests/Timing_Test.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I. `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/Timing_Test.o ../../../src/integrationTests/Timing_Test.cc


${TESTDIR}/_ext/567603001/integrationRunner_8.o: ../../../src/integrationTests/integrationRunner_8.cc 
	${MKDIR} -p ${TESTDIR}/_ext/567603001
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/integrationTests/\" -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I. `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/567603001/integrationRunner_8.o ../../../src/integrationTests/integrationRunner_8.cc
