...
${OBJECTDIR}/_ext/567603001/dummy.o: ../../../src/integrationTests/dummy.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -D__SO__ -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python3.4 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/567603001/dummy.o ../../../src/integrationTests/dummy.cc
...
${OBJECTDIR}/_ext/567603001/dummy_nomain.o: ${OBJECTDIR}/_ext/567603001/dummy.o ../../../src/integrationTests/dummy.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -D__SO__ -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python3.4 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}` -std=c++11  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/567603001/dummy_nomain.o ../../../src/integrationTests/dummy.cc;\
	else  \
