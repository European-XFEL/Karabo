...
DEPENDENCIES_Linux_NoGui=( python2.7 lapack numpy scipy nose libpng freetype pil matplotlib pexpect tornado pyzmq pygments ipython boost openmqc hdf5 h5py log4cpp cppunit openmq pyusb parse )
