...
DEPENDENCIES_Linux_NoGui=( python3.4 lapack numpy scipy nose libpng freetype pillow matplotlib pexpect tornado pyzmq pygments ipython boost openmqc hdf5 h5py log4cpp cppunit openmq pyusb parse )
