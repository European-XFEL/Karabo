...
DEPENDENCIES_Linux=( python2.7 lapack numpy scipy nose libpng freetype qt4 sip pyqt4 tornado pyparsing six setuptools dateutil pytz matplotlib pyqwt5 cython guidata guiqwt pexpect pyzmq pygments ipython boost hdf5 h5py log4cpp cppunit openmq openmqc )
