...
DEPENDENCIES_Linux=( python2.7 cython lapack numpy scipy nose libpng freetype qt4 sip pyqt4 backports tornado pyparsing six setuptools dateutil pytz matplotlib pyqwt5 guidata guiqwt pexpect pyzmq markupsafe jinja2 pygments ipython boost hdf5 h5py log4cpp cppunit openmq openmqc pyusb parse )
