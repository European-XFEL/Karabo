...
${OBJECTDIR}/_ext/163556830/Runner.o: ../../../src/karabo/core/Runner.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/163556830
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python3.4 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/163556830/Runner.o ../../../src/karabo/core/Runner.cc
...
${OBJECTDIR}/_ext/163556830/Runner_nomain.o: ${OBJECTDIR}/_ext/163556830/Runner.o ../../../src/karabo/core/Runner.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -w -D__SO__ -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python3.4 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}` -std=c++11  -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/163556830/Runner_nomain.o ../../../src/karabo/core/Runner.cc;\
	else  \
