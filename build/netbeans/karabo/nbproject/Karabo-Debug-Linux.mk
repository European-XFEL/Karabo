...
OBJECTFILES= \
	...
	${OBJECTDIR}/_ext/163556830/State.o \
	${OBJECTDIR}/_ext/163556830/StateSignifier.o \
...
${OBJECTDIR}/_ext/163556830/State.o: ../../../src/karabo/core/State.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/163556830
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python3.4 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/163556830/State.o ../../../src/karabo/core/State.cc

${OBJECTDIR}/_ext/163556830/StateSignifier.o: ../../../src/karabo/core/StateSignifier.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/163556830
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python3.4 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/163556830/StateSignifier.o ../../../src/karabo/core/StateSignifier.cc
...
${OBJECTDIR}/_ext/1072794519/SchemaXsdSerializer.o: ../../../src/karabo/io/SchemaXsdSerializer.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/1072794519
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python3.4 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1072794519/SchemaXsdSerializer.o ../../../src/karabo/io/SchemaXsdSerializer.cc
...
${TESTDIR}/TestFiles/f4: ${TESTDIR}/_ext/936498188/JmsBroker_Test.o ${TESTDIR}/_ext/936498188/MQTcpNetworking.o ${TESTDIR}/_ext/936498188/TcpNetworking_Test.o ${TESTDIR}/_ext/936498188/netTestRunner.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}/TestFiles
...
${TESTDIR}/_ext/861493463/SchemaXsdSerializer_Test.o: ../../../src/karabo/tests/io/SchemaXsdSerializer_Test.cc 
	${MKDIR} -p ${TESTDIR}/_ext/861493463
	${RM} "$@.d"
	$(COMPILE.cc) -g -w -D__SO__ -DKARABO_TESTPATH=\"${CND_BASEDIR}/../../../src/karabo/tests/\" -DKARABO_NO_ENABLE_TRACE_LOG -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python3.4 -I${KARABO}/extern/include/hdf5 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`  -O2 -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/861493463/SchemaXsdSerializer_Test.o ../../../src/karabo/tests/io/SchemaXsdSerializer_Test.cc
...
${OBJECTDIR}/_ext/163556830/State_nomain.o: ${OBJECTDIR}/_ext/163556830/State.o ../../../src/karabo/core/State.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/163556830
	@NMOUTPUT=`${NM} ${OBJECTDIR}/_ext/163556830/State.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -w -D__SO__ -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python3.4 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/163556830/State_nomain.o ../../../src/karabo/core/State.cc;\
	else  \
	    ${CP} ${OBJECTDIR}/_ext/163556830/State.o ${OBJECTDIR}/_ext/163556830/State_nomain.o;\
	fi

${OBJECTDIR}/_ext/163556830/StateSignifier_nomain.o: ${OBJECTDIR}/_ext/163556830/StateSignifier.o ../../../src/karabo/core/StateSignifier.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/163556830
	@NMOUTPUT=`${NM} ${OBJECTDIR}/_ext/163556830/StateSignifier.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -w -D__SO__ -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python3.4 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/163556830/StateSignifier_nomain.o ../../../src/karabo/core/StateSignifier.cc;\
	else  \
	    ${CP} ${OBJECTDIR}/_ext/163556830/StateSignifier.o ${OBJECTDIR}/_ext/163556830/StateSignifier_nomain.o;\
	fi
...
${OBJECTDIR}/_ext/1072794519/SchemaXsdSerializer_nomain.o: ${OBJECTDIR}/_ext/1072794519/SchemaXsdSerializer.o ../../../src/karabo/io/SchemaXsdSerializer.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -w -D__SO__ -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python3.4 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1072794519/SchemaXsdSerializer_nomain.o ../../../src/karabo/io/SchemaXsdSerializer.cc;\
	else  \
