...
${OBJECTDIR}/_ext/1423485062/RunConfigurationGroup.o: ../../../src/karabo/devices/RunConfigurationGroup.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/1423485062
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -D__SO__ -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python3.4 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1423485062/RunConfigurationGroup.o ../../../src/karabo/devices/RunConfigurationGroup.cc
