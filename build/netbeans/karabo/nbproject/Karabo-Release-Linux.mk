...
${OBJECTDIR}/_ext/163556830/DataLoggerStructs.o: ../../../src/karabo/core/DataLoggerStructs.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/163556830
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -D__SO__ -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python3.4 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/163556830/DataLoggerStructs.o ../../../src/karabo/core/DataLoggerStructs.cc
...
${OBJECTDIR}/_ext/163556830/DataLoggerStructs_nomain.o: ${OBJECTDIR}/_ext/163556830/DataLoggerStructs.o ../../../src/karabo/core/DataLoggerStructs.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -D__SO__ -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python3.4 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/163556830/DataLoggerStructs_nomain.o ../../../src/karabo/core/DataLoggerStructs.cc;\
	else  \
