...
${OBJECTDIR}/_ext/163016059/Overflow.o: ../../../src/karabo/util/Overflow.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/163016059
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -D__SO__ -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python3.4 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/163016059/Overflow.o ../../../src/karabo/util/Overflow.cc
...
${OBJECTDIR}/_ext/163016059/Overflow_nomain.o: ${OBJECTDIR}/_ext/163016059/Overflow.o ../../../src/karabo/util/Overflow.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -D__SO__ -I../../../src -I${KARABO}/extern/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python3.4 `pkg-config --cflags karaboDependencies-${CND_PLATFORM}` -std=c++11  -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/163016059/Overflow_nomain.o ../../../src/karabo/util/Overflow.cc;\
	else  \
