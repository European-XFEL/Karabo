...
${OBJECTDIR}/_ext/381567218/PyCoreLockWrap.o: ../../../src/karathon/PyCoreLockWrap.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/381567218
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -I../../../src -I${KARABO}/include -I${KARABO}/extern/include/hdf5 -I${NUMPY_HEADER_DIR} -I${KARABO}/extern/include/python3.4 -I${KARABO}/extern/include `pkg-config --cflags karathonDependencies-${CND_PLATFORM}` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/381567218/PyCoreLockWrap.o ../../../src/karathon/PyCoreLockWrap.cc
