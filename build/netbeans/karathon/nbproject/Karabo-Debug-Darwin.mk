...
LDLIBSOPTIONS=-L${KARABO}/lib -L${KARABO}/extern/lib -L../karabo/dist/Debug/GNU_MacPorts-MacOSX/lib -lkarabo `pkg-config --libs karathonDependencies-${CND_PLATFORM}`  

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lib/karathon.${CND_DLIB_EXT}

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lib/karathon.${CND_DLIB_EXT}: ../karabo/dist/Debug/GNU_MacPorts-MacOSX/lib/libkarabo.dylib
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/HashWrap_Test.o ${TESTDIR}/tests/karathonTestRunner.o ${OBJECTFILES:%.o=%_nomain.o}
	...
	${LINK.cc}   -o ${TESTDIR}/TestFiles/f1 $^ ${LDLIBSOPTIONS} -L${KARABO}/extern/lib -lcppunit `cppunit-config --libs`   
