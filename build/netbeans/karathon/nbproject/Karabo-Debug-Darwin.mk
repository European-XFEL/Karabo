...
LDLIBSOPTIONS=-L${KARABO}/lib -L${KARABO}/extern/lib -L../karabo/dist/Debug/GNU-MacOSX/lib -lkarabo `pkg-config --libs karathonDependencies-${CND_PLATFORM}`  

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lib/karathon.${CND_DLIB_EXT}

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lib/karathon.${CND_DLIB_EXT}: ../karabo/dist/Debug/GNU-MacOSX/lib/libkarabo.dylib
