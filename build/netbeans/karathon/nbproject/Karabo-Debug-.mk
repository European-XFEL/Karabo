...
${OBJECTDIR}/_ext/381567218/HashWrap.o: ../../../src/karathon/HashWrap.cc 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -DKARATHON_BOOST_NUMPY -I../../../src -I${KARATHON}/karabo/include -I${KARATHON}/karabo/extern/include/hdf5 -I${KARATHON}/karabo/extern/include/python2.7 -I${KARATHON}/karabo/extern/include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/381567218/HashWrap.o ../../../src/karathon/HashWrap.cc
...
${OBJECTDIR}/_ext/381567218/karathon.o: ../../../src/karathon/karathon.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/381567218
	${RM} $@.d
	$(COMPILE.cc) -g -DKARATHON_BOOST_NUMPY -I../../../src -I${KARATHON}/karabo/include -I${KARATHON}/karabo/extern/include/hdf5 -I${KARATHON}/karabo/extern/include/python2.7 -I${KARATHON}/karabo/extern/include -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/381567218/karathon.o ../../../src/karathon/karathon.cc
...
${OBJECTDIR}/_ext/381567218/HashWrap_nomain.o: ${OBJECTDIR}/_ext/381567218/HashWrap.o ../../../src/karathon/HashWrap.cc 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -DKARATHON_BOOST_NUMPY -I../../../src -I${KARATHON}/karabo/include -I${KARATHON}/karabo/extern/include/hdf5 -I${KARATHON}/karabo/extern/include/python2.7 -I${KARATHON}/karabo/extern/include -fPIC  -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/381567218/HashWrap_nomain.o ../../../src/karathon/HashWrap.cc;\
	else  \
...
${OBJECTDIR}/_ext/381567218/karathon_nomain.o: ${OBJECTDIR}/_ext/381567218/karathon.o ../../../src/karathon/karathon.cc 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -DKARATHON_BOOST_NUMPY -I../../../src -I${KARATHON}/karabo/include -I${KARATHON}/karabo/extern/include/hdf5 -I${KARATHON}/karabo/extern/include/python2.7 -I${KARATHON}/karabo/extern/include -fPIC  -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/381567218/karathon_nomain.o ../../../src/karathon/karathon.cc;\
	else  \
