...
${OBJECTDIR}/_ext/381567218/PyUtilDateTimeString.o: ../../../src/karathon/PyUtilDateTimeString.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/381567218
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../../../src -I${KARABO}/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python2.7 -I${KARABO}/extern/lib/python2.7/site-packages/numpy/core/include -I${KARABO}/extern/include `pkg-config --cflags karathonDependencies-${CND_PLATFORM}`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/381567218/PyUtilDateTimeString.o ../../../src/karathon/PyUtilDateTimeString.cc
...
${OBJECTDIR}/_ext/381567218/PyUtilTimeDuration.o: ../../../src/karathon/PyUtilTimeDuration.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/381567218
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../../../src -I${KARABO}/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python2.7 -I${KARABO}/extern/lib/python2.7/site-packages/numpy/core/include -I${KARABO}/extern/include `pkg-config --cflags karathonDependencies-${CND_PLATFORM}`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/381567218/PyUtilTimeDuration.o ../../../src/karathon/PyUtilTimeDuration.cc
...
${OBJECTDIR}/_ext/381567218/PyXipCpuImage.o: ../../../src/karathon/PyXipCpuImage.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/381567218
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I../../../src -I${KARABO}/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python2.7 -I${KARABO}/extern/lib/python2.7/site-packages/numpy/core/include -I${KARABO}/extern/include `pkg-config --cflags karathonDependencies-${CND_PLATFORM}`  -Wno-unused-but-set-variable -Wno-strict-aliasing -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/381567218/PyXipCpuImage.o ../../../src/karathon/PyXipCpuImage.cc
...
${OBJECTDIR}/_ext/381567218/PyXipCpuImage_nomain.o: ${OBJECTDIR}/_ext/381567218/PyXipCpuImage.o ../../../src/karathon/PyXipCpuImage.cc 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -I../../../src -I${KARABO}/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python2.7 -I${KARABO}/extern/lib/python2.7/site-packages/numpy/core/include -I${KARABO}/extern/include `pkg-config --cflags karathonDependencies-${CND_PLATFORM}`  -Wno-unused-but-set-variable -Wno-strict-aliasing -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/381567218/PyXipCpuImage_nomain.o ../../../src/karathon/PyXipCpuImage.cc;\
	else  \
