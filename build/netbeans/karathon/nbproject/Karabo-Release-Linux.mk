...
${OBJECTDIR}/_ext/381567218/PyUtilStateElement.o: ../../../src/karathon/PyUtilStateElement.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/381567218
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -DNPY_NO_DEPRECATED_API=NPY_1_7_API_VERSION -I../../../src -I${KARABO}/include -I${KARABO}/extern/include/hdf5 -I${KARABO}/extern/include/python3.4 -I${NUMPY_HEADER_DIR} -I${KARABO}/extern/include `pkg-config --cflags karathonDependencies-${CND_PLATFORM}` -std=c++11  -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/381567218/PyUtilStateElement.o ../../../src/karathon/PyUtilStateElement.cc
