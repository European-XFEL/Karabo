...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/bin/karabo-brokerrates: ../../karabo/dist/Release/GNU_MacPorts-MacOSX/lib/libkarabo.dylib

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/bin/karabo-brokerrates: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/bin
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/bin/karabo-brokerrates ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/_ext/1625554341/brokerRates.o: ../../../../src/tools/brokerRates/brokerRates.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1625554341
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../../src -I${KARABO}/include -I${KARABO}/extern/include `pkg-config --cflags karaboDependencies-${CND_PLATFORM}`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1625554341/brokerRates.o ../../../../src/tools/brokerRates/brokerRates.cpp
