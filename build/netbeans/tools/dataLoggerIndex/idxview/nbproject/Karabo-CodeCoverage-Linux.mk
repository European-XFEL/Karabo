...
${OBJECTDIR}/_ext/1310162774/idxView.o: ../../../../../src/tools/dataLoggerIndex/idxView.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../../../src/tools/dataLoggerIndex -I${KARABO}/include -I${KARABO}/extern/include `pkg-config --cflags karaboDependencies-${CND_PLATFORM}` -std=c++11  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1310162774/idxView.o ../../../../../src/tools/dataLoggerIndex/idxView.cc
