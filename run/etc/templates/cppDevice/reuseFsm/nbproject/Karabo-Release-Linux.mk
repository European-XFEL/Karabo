...
${TESTDIR}/__CLASS_NAME__: ${TESTDIR}/src/tests/__CLASS_NAME___App.o ${OBJECTFILES:%.o=%_nomain.o}
	${MKDIR} -p ${TESTDIR}
	${LINK.cc}   -o ${TESTDIR}/__CLASS_NAME__ $^ ${LDLIBSOPTIONS} 


${TESTDIR}/src/tests/__CLASS_NAME___App.o: src/tests/__CLASS_NAME___App.cc 
	${MKDIR} -p ${TESTDIR}/src/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I${KARABO}/extern/include -I${KARABO}/include -I. `pkg-config --cflags karaboDependencies`   -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/__CLASS_NAME___App.o src/tests/__CLASS_NAME___App.cc
