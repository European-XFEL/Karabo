...
${TESTDIR}/src/tests/__CLASS_NAME___Test.o: src/tests/__CLASS_NAME___Test.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -I${KARABO}/extern/include -I${KARABO}/include -I. `pkg-config --cflags karaboDependencies`   -MMD -MP -MF "$@.d" -o ${TESTDIR}/src/tests/__CLASS_NAME___Test.o src/tests/__CLASS_NAME___Test.cc
