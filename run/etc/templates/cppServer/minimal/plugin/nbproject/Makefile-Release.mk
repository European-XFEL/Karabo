...
${OBJECTDIR}/_ext/1360937237/__CLASS_NAME__.o: ../src/__CLASS_NAME__.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I${KARABO}/extern/include -I${KARABO}/include -I. `pkg-config --cflags karaboDependencies`   -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1360937237/__CLASS_NAME__.o ../src/__CLASS_NAME__.cc
