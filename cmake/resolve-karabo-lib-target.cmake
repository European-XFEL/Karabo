macro (resolveKaraboLibTarget)
    ...
    if (NOT TARGET ${KARABO_LIB_TARGET_NAME})
        ...
        if ("${KARABO_LIB_DIR}" STREQUAL "${CMAKE_PREFIX_PATH}/lib")
            ...
            # TODO: replace the hardcoded target properties with programatical generation from the Karabo Lib CMake project.
            set_target_properties(${KARABO_LIB_TARGET_NAME} PROPERTIES
                INTERFACE_COMPILE_DEFINITIONS "__SO__"
                INTERFACE_COMPILE_OPTIONS "-Wno-unused-local-typedefs;-Wno-deprecated-declarations;-Wall" # "-Wfatal-errors;-Wno-unused-local-typedefs;-Wno-deprecated-declarations;-Wall"
                INTERFACE_INCLUDE_DIRECTORIES "${CMAKE_PREFIX_PATH}/include/karabo;${CMAKE_PREFIX_PATH}/include;${CMAKE_PREFIX_PATH}/include/hdf5"
                INTERFACE_LINK_LIBRARIES "${CMAKE_PREFIX_PATH}/lib/libboost_filesystem.so;${CMAKE_PREFIX_PATH}/lib/libboost_system.so;${CMAKE_PREFIX_PATH}/lib/libboost_chrono.so;${CMAKE_PREFIX_PATH}/lib/libboost_date_time.so;${CMAKE_PREFIX_PATH}/lib/libboost_regex.so;${CMAKE_PREFIX_PATH}/lib/libboost_signals.so;${CMAKE_PREFIX_PATH}/lib/libboost_thread.so;${CMAKE_PREFIX_PATH}/lib/libhdf5.so;${CMAKE_PREFIX_PATH}/lib/libssl.so;${CMAKE_PREFIX_PATH}/lib/libcrypto.so;${CMAKE_PREFIX_PATH}/lib/libopenmqc.so;${CMAKE_PREFIX_PATH}/lib/liblog4cpp.so;${CMAKE_PREFIX_PATH}/lib/libpugixml.so"
