...
attrs colorama iniconfig atomicwrites pytest pytest_runner pytest_cov
pytest_asyncio pillow sip backports backports_abc tornado dateutil ptyprocess
pytz pexpect pyzmq markupsafe jinja2 pygments decorator traitlets parso
ipython_genutils jedi pickleshare wcwidth backcall prompt_toolkit ipython
